...
**Reading Guide** - 459 lines, 12 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Reconciliation runs in both directions {#both-directions} | 39-101 |
| The `Last Updated` stamp is derived too {#last-updated-stamp} | 102-117 |
| Self-diagnosing count-mismatch findings {#count-mismatch-diagnosis} | 118-132 |
| /sdlc-studio reconcile - Step by Step {#reconcile-workflow} | 133-134 |
| &nbsp;&nbsp;1. Parse Arguments | 135-142 |
| &nbsp;&nbsp;2. Phase 1: Collect Ground Truth | 143-176 |
| &nbsp;&nbsp;3. Phase 2: Detect Drift | 177-303 |
| &nbsp;&nbsp;4. Phase 3: Report or Apply | 304-400 |
| &nbsp;&nbsp;5. Scope Filtering {#verify-scope} | 401-417 |
| Principles | 418-426 |
| Cadence Triggers {#cadence-triggers} | 427-454 |
| See Also | 455-459 |
