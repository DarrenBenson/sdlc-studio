...
**Reading Guide** - 812 lines, 46 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Related References | 60-93 |
| PRD Decisions {#prd-decisions} | 94-105 |
| TRD Decisions {#trd-decisions} | 106-116 |
| Epic Decisions {#epic-decisions} | 117-125 |
| Story Decisions {#story-decisions} | 126-134 |
| Plan Decisions {#plan-decisions} | 135-144 |
| Execution Contract After Plan Approval {#execution-contract} | 145-174 |
| Release Strategy Decision {#release-strategy-decision} | 175-249 |
| Prefer TDD When {#prefer-tdd} | 250-260 |
| Prefer Test-After When {#prefer-test-after} | 261-271 |
| Override Flags {#override-flags} | 272-301 |
| PRD Ready {#prd-ready} | 302-318 |
| TRD Ready {#trd-ready} | 319-336 |
| Epic Ready {#epic-ready} | 337-353 |
| Definition of Ready / Definition of Done {#dor-dod} | 354-380 |
| Story Ready {#story-ready} | 381-410 |
| Plan Ready {#plan-ready} | 411-428 |
| Test-Spec Ready {#test-spec-ready} | 429-471 |
| PRD → Epic Validation {#prd-epic-validation} | 472-484 |
| Epic → Story Validation {#epic-story-validation} | 485-497 |
| Story → Plan Validation {#story-plan-validation} | 498-510 |
| Story → Test-Spec Validation {#story-test-spec-validation} | 511-522 |
| Test → Story Validation (Backward Traceability) {#test-story-validation} | 523-534 |
| Story Terminal Status Validation {#story-terminal-validation} | 535-554 |
| Detection Patterns {#detection-patterns} | 555-563 |
| Workflow Change {#workflow-change} | 564-598 |
| From PRD to Epic {#prd-to-epic} | 599-608 |
| From TRD to Epic {#trd-to-epic} | 609-616 |
| From Epic to Story {#epic-to-story} | 617-625 |
| From Story to Plan {#story-to-plan} | 626-634 |
| From Story to Test-Spec {#story-to-test-spec} | 635-649 |
| Story Workflow Checkpoints {#story-workflow-checkpoints} | 650-653 |
| &nbsp;&nbsp;Phase 1: Plan {#phase-1-plan} | 654-663 |
| &nbsp;&nbsp;Phase 2: Test Spec {#phase-2-test-spec} | 664-674 |
| &nbsp;&nbsp;Phase 3: Tests {#phase-3-tests} | 675-684 |
| &nbsp;&nbsp;Phase 4: Implement {#phase-4-implement} | 685-694 |
| &nbsp;&nbsp;Phase 5: Test {#phase-5-test} | 695-704 |
| &nbsp;&nbsp;Phase 6: Verify {#phase-6-verify} | 705-714 |
| &nbsp;&nbsp;Phase 7: Check {#phase-7-check} | 715-724 |
| &nbsp;&nbsp;Phase 8: Review {#phase-8-review} | 725-735 |
| Epic Workflow Checkpoints {#epic-workflow-checkpoints} | 736-737 |
| &nbsp;&nbsp;Pre-execution {#epic-pre-execution} | 738-746 |
| &nbsp;&nbsp;Per-story {#epic-per-story} | 747-754 |
| &nbsp;&nbsp;Per-wave (agentic mode only) {#epic-per-wave} | 755-761 |
| &nbsp;&nbsp;Post-execution {#epic-post-execution} | 762-771 |
| Checkpoint Recovery {#checkpoint-recovery} | 772-812 |
