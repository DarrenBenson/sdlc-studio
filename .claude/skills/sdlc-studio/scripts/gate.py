...
# Empty now the mutation lane has left the gate: mutation testing is
# `mutation.py run`, picked up on purpose, and no gate lane reads its report.
ADVISORY_WHEN_ABSENT: dict[str, dict] = {}
