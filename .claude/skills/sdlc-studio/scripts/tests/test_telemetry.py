...
class TierFieldsTests(unittest.TestCase):
    ...
    def test_a_historical_event_is_not_a_unit(self) -> None:
        """An old log still holds plan-review events; they are neither a unit nor a block."""
        ...
        self.assertEqual(set(s), {"story"})            # no phantom bucket, no event block
