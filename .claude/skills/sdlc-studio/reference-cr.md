...
**Reading Guide** - 508 lines, 15 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| /sdlc-studio cr - Step by Step {#cr-default} | 29-46 |
| /sdlc-studio cr create - Step by Step {#cr-create-workflow} | 47-120 |
| /sdlc-studio cr list - Step by Step {#cr-list-workflow} | 121-153 |
| What `refine` produces {#refine-output} | 154-181 |
| /sdlc-studio cr action - Step by Step {#cr-action-workflow} | 182-282 |
| /sdlc-studio cr review - Step by Step {#cr-review-workflow} | 283-331 |
| /sdlc-studio cr sync - Step by Step {#cr-sync-workflow} | 332-396 |
| /sdlc-studio cr close - Step by Step {#cr-close-workflow} | 397-441 |
| Integration with Existing Workflows {#cr-integration} | 442-443 |
| Status Dashboard {#cr-status-integration} | 444-455 |
| Hint {#cr-hint-integration} | 456-463 |
| Reconcile {#cr-reconcile-integration} | 464-479 |
| Review {#cr-review-integration} | 480-489 |
| Principles {#cr-principles} | 490-500 |
| See Also | 501-508 |
