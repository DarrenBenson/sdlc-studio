...
**Reading Guide** - 522 lines, 16 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Reading Guide | 30-42 |
| /sdlc-studio cr - Step by Step {#cr-default} | 43-60 |
| /sdlc-studio cr create - Step by Step {#cr-create-workflow} | 61-134 |
| /sdlc-studio cr list - Step by Step {#cr-list-workflow} | 135-167 |
| What `refine` produces {#refine-output} | 168-195 |
| /sdlc-studio cr action - Step by Step {#cr-action-workflow} | 196-296 |
| /sdlc-studio cr review - Step by Step {#cr-review-workflow} | 297-345 |
| /sdlc-studio cr sync - Step by Step {#cr-sync-workflow} | 346-410 |
| /sdlc-studio cr close - Step by Step {#cr-close-workflow} | 411-455 |
| Integration with Existing Workflows {#cr-integration} | 456-457 |
| Status Dashboard {#cr-status-integration} | 458-469 |
| Hint {#cr-hint-integration} | 470-477 |
| Reconcile {#cr-reconcile-integration} | 478-493 |
| Review {#cr-review-integration} | 494-503 |
| Principles {#cr-principles} | 504-514 |
| See Also | 515-522 |
