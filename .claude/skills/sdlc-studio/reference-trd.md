...
**Reading Guide** - 452 lines, 11 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| /sdlc-studio trd create - Step by Step {#trd-create-workflow} | 29-118 |
| /sdlc-studio trd generate - Step by Step {#trd-generate-workflow} | 119-257 |
| /sdlc-studio trd review - Step by Step {#trd-review-workflow} | 258-303 |
| /sdlc-studio trd visualise - Step by Step {#trd-visualise-workflow} | 304-363 |
| Diagram Guidelines {#diagram-guidelines} | 364-365 |
| &nbsp;&nbsp;Element Limits | 366-373 |
| &nbsp;&nbsp;Naming Conventions | 374-381 |
| &nbsp;&nbsp;Visual Hierarchy | 382-391 |
| &nbsp;&nbsp;Connection Labels | 392-399 |
| &nbsp;&nbsp;Subgraphs | 400-432 |
| Navigation {#navigation} | 433-452 |
