...
**Reading Guide** - 494 lines, 26 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| /sdlc-studio test-automation - Step by Step | 42-43 |
| &nbsp;&nbsp;1. Check Prerequisites | 44-48 |
| &nbsp;&nbsp;2. Implementation Discovery (CRITICAL) | 49-111 |
| &nbsp;&nbsp;3. Detect Language | 112-139 |
| &nbsp;&nbsp;4. Detect Framework | 140-146 |
| &nbsp;&nbsp;5. Parse Test Specs | 147-153 |
| &nbsp;&nbsp;6. Select Template | 154-165 |
| &nbsp;&nbsp;7. Generate Test Code | 166-175 |
| &nbsp;&nbsp;8. Determine Output Location | 176-189 |
| &nbsp;&nbsp;9. Write Test Files | 190-195 |
| &nbsp;&nbsp;10. Update Specs | 196-201 |
| &nbsp;&nbsp;11. Run Generated Tests | 202-216 |
| &nbsp;&nbsp;12. Report | 217-225 |
| Test Generation Examples | 226-227 |
| &nbsp;&nbsp;Python/pytest Example | 228-273 |
| &nbsp;&nbsp;TypeScript/Jest Example | 274-307 |
| Test Environment Workflows | 308-309 |
| &nbsp;&nbsp;/sdlc-studio test-env setup - Step by Step | 310-370 |
| &nbsp;&nbsp;/sdlc-studio test-env up - Step by Step | 371-402 |
| &nbsp;&nbsp;/sdlc-studio test-env down - Step by Step | 403-420 |
| Running Tests Against Containers | 421-422 |
| &nbsp;&nbsp;Integration Tests | 423-435 |
| &nbsp;&nbsp;E2E Tests | 436-448 |
| &nbsp;&nbsp;CI/CD Integration | 449-475 |
| Error Handling | 476-486 |
| See Also | 487-494 |
