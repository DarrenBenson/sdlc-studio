...
It allocates the ID, renders the structured artifact, appends the index row, and
recomputes the index counts. Triage first (review the survivors), then file the
approved set.
