...
**Reading Guide** - 514 lines, 18 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Which persona doc? {#which-doc} | 32-48 |
| The cast (goal-directed design personas) {#categories} | 49-92 |
| Choosing the Primary {#choosing-the-primary} | 93-121 |
| Archetype Personas {#archetypes} | 122-175 |
| /sdlc-studio persona create {#persona-create-workflow} | 176-225 |
| /sdlc-studio persona generate {#persona-generate-workflow} | 226-229 |
| &nbsp;&nbsp;Source: PRD (`--from-prd`) | 230-263 |
| &nbsp;&nbsp;Source: Codebase (`--from-code`) | 264-293 |
| &nbsp;&nbsp;Source: Documentation (`--from-docs`) | 294-311 |
| /sdlc-studio persona import {#persona-import-workflow} | 312-333 |
| /sdlc-studio persona list {#persona-list-workflow} | 334-360 |
| /sdlc-studio persona review {#persona-review-workflow} | 361-401 |
| Required Sections (a well-formed persona) | 402-427 |
| Scenario taxonomy {#scenario-taxonomy} | 428-440 |
| Template Location | 441-448 |
| When to Use Personas | 449-459 |
| Cost Controls | 460-494 |
| Navigation {#navigation} | 495-514 |
