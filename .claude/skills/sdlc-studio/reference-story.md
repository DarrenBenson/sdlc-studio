...
**Reading Guide** - 1091 lines, 35 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Story Workflows | 49-50 |
| /sdlc-studio story - Step by Step {#story-workflow} | 51-198 |
| /sdlc-studio story create --from-issue - Ingesting a GitHub issue {#story-from-issue} | 199-212 |
| Story Cohesion Review (Post-Generation) {#story-cohesion-review} | 213-216 |
| &nbsp;&nbsp;Trigger | 217-220 |
| &nbsp;&nbsp;Cohesion Checks | 221-231 |
| &nbsp;&nbsp;Cohesion Review Workflow {#cohesion-workflow} | 232-273 |
| &nbsp;&nbsp;Cohesion Report Output {#cohesion-output} | 274-302 |
| &nbsp;&nbsp;Auto-Fix Behaviour {#cohesion-auto-fix} | 303-312 |
| &nbsp;&nbsp;Cohesion Findings Storage {#cohesion-storage} | 313-322 |
| /sdlc-studio story review - Step by Step {#story-review-workflow} | 323-364 |
| /sdlc-studio story generate - Step by Step (Specification Extraction) {#story-generate-workflow} | 365-469 |
| Story Quality Enforcement | 470-475 |
| Story Ready Validation (Enforced) {#ready-validation} | 476-479 |
| &nbsp;&nbsp;API Stories {#api-stories} | 480-489 |
| &nbsp;&nbsp;UI Stories {#ui-stories} | 490-499 |
| &nbsp;&nbsp;Validation Algorithm {#validation-algorithm} | 500-512 |
| &nbsp;&nbsp;Validation Output {#validation-output} | 513-546 |
| Quality Checklist {#quality-checklist} | 547-548 |
| &nbsp;&nbsp;All Stories {#all-stories} | 549-556 |
| Blocking Conditions {#blocking-conditions} | 557-568 |
| Ambiguous Language Detection {#ambiguous-language-detection} | 569-574 |
| Quality Metrics {#quality-metrics} | 575-593 |
| User Story Section Reference | 594-597 |
| &nbsp;&nbsp;Rollback envelope {#rollback-envelope} | 598-635 |
| &nbsp;&nbsp;Verification target per AC {#ac-verification-target} | 636-654 |
| Workflow Commands | 655-660 |
| /sdlc-studio story plan - Step by Step {#story-plan-workflow} | 661-762 |
| /sdlc-studio story implement - Step by Step {#story-implement-workflow} | 763-764 |
| &nbsp;&nbsp;Agentic Mode Behaviour {#agentic-override} | 765-1011 |
| Workflow Error Handling {#workflow-error-handling} | 1012-1013 |
| &nbsp;&nbsp;Phase-Specific Errors {#phase-specific-errors} | 1014-1027 |
| &nbsp;&nbsp;Recovery Strategies {#story-recovery-strategies} | 1028-1056 |
| See Also | 1057-1070 |
| Navigation {#navigation} | 1071-1091 |
