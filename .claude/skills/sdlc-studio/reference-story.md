...
**Reading Guide** - 1107 lines, 36 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Reading Guide | 50-64 |
| Story Workflows | 65-66 |
| /sdlc-studio story - Step by Step {#story-workflow} | 67-214 |
| /sdlc-studio story create --from-issue - Ingesting a GitHub issue {#story-from-issue} | 215-228 |
| Story Cohesion Review (Post-Generation) {#story-cohesion-review} | 229-232 |
| &nbsp;&nbsp;Trigger | 233-236 |
| &nbsp;&nbsp;Cohesion Checks | 237-247 |
| &nbsp;&nbsp;Cohesion Review Workflow {#cohesion-workflow} | 248-289 |
| &nbsp;&nbsp;Cohesion Report Output {#cohesion-output} | 290-318 |
| &nbsp;&nbsp;Auto-Fix Behaviour {#cohesion-auto-fix} | 319-328 |
| &nbsp;&nbsp;Cohesion Findings Storage {#cohesion-storage} | 329-338 |
| /sdlc-studio story review - Step by Step {#story-review-workflow} | 339-380 |
| /sdlc-studio story generate - Step by Step (Specification Extraction) {#story-generate-workflow} | 381-485 |
| Story Quality Enforcement | 486-491 |
| Story Ready Validation (Enforced) {#ready-validation} | 492-495 |
| &nbsp;&nbsp;API Stories {#api-stories} | 496-505 |
| &nbsp;&nbsp;UI Stories {#ui-stories} | 506-515 |
| &nbsp;&nbsp;Validation Algorithm {#validation-algorithm} | 516-528 |
| &nbsp;&nbsp;Validation Output {#validation-output} | 529-562 |
| Quality Checklist {#quality-checklist} | 563-564 |
| &nbsp;&nbsp;All Stories {#all-stories} | 565-572 |
| Blocking Conditions {#blocking-conditions} | 573-584 |
| Ambiguous Language Detection {#ambiguous-language-detection} | 585-590 |
| Quality Metrics {#quality-metrics} | 591-609 |
| User Story Section Reference | 610-613 |
| &nbsp;&nbsp;Rollback envelope {#rollback-envelope} | 614-651 |
| &nbsp;&nbsp;Verification target per AC {#ac-verification-target} | 652-670 |
| Workflow Commands | 671-676 |
| /sdlc-studio story plan - Step by Step {#story-plan-workflow} | 677-778 |
| /sdlc-studio story implement - Step by Step {#story-implement-workflow} | 779-780 |
| &nbsp;&nbsp;Agentic Mode Behaviour {#agentic-override} | 781-1027 |
| Workflow Error Handling {#workflow-error-handling} | 1028-1029 |
| &nbsp;&nbsp;Phase-Specific Errors {#phase-specific-errors} | 1030-1043 |
| &nbsp;&nbsp;Recovery Strategies {#story-recovery-strategies} | 1044-1072 |
| See Also | 1073-1086 |
| Navigation {#navigation} | 1087-1107 |
