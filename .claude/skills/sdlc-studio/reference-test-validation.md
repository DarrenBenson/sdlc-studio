...
**Reading Guide** - 550 lines, 34 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Contents | 46-60 |
| Related References {#test-validation-related-references} | 61-70 |
| Validation Steps {#validation-steps} | 71-102 |
| E2E Tests and the API Mock Gap {#e2e-api-mock-gap} | 103-104 |
| &nbsp;&nbsp;The Problem {#mock-gap-problem} | 105-115 |
| &nbsp;&nbsp;The Solution: API Contract Tests {#mock-gap-solution} | 116-153 |
| &nbsp;&nbsp;Recommendation {#mock-gap-recommendation} | 154-159 |
| Parameterised Testing {#parameterised-testing} | 160-163 |
| &nbsp;&nbsp;Python (pytest) {#parameterised-python} | 164-178 |
| &nbsp;&nbsp;TypeScript (vitest/jest) {#parameterised-typescript} | 179-191 |
| &nbsp;&nbsp;Go (table-driven) {#parameterised-go} | 192-217 |
| Test Data Management {#test-data-management} | 218-219 |
| &nbsp;&nbsp;Unified Fixtures Directory {#unified-fixtures-directory} | 220-236 |
| &nbsp;&nbsp;Factory Functions vs Fixture Files {#factory-vs-fixture-files} | 237-276 |
| &nbsp;&nbsp;Sensitive Data Handling {#sensitive-data-handling} | 277-285 |
| Flakiness Prevention {#flakiness-prevention} | 286-289 |
| &nbsp;&nbsp;Test Isolation {#test-isolation} | 290-316 |
| &nbsp;&nbsp;Database Cleanup {#database-cleanup} | 317-343 |
| &nbsp;&nbsp;Retry Strategies {#retry-strategies} | 344-358 |
| &nbsp;&nbsp;Parallel Test Execution {#parallel-test-execution} | 359-381 |
| Test Performance {#test-performance} | 382-383 |
| &nbsp;&nbsp;Unit Test Speed {#unit-test-speed} | 384-402 |
| &nbsp;&nbsp;Integration Test Batching {#integration-test-batching} | 403-425 |
| &nbsp;&nbsp;Selective Test Running {#selective-test-running} | 426-448 |
| Property-Based Testing {#property-based-testing} | 449-452 |
| &nbsp;&nbsp;When to Use {#property-when-to-use} | 453-459 |
| &nbsp;&nbsp;Python (Hypothesis) {#property-python} | 460-475 |
| &nbsp;&nbsp;TypeScript (fast-check) {#property-typescript} | 476-491 |
| Snapshot Testing {#snapshot-testing} | 492-495 |
| &nbsp;&nbsp;When to Use {#snapshot-when-to-use} | 496-504 |
| &nbsp;&nbsp;Python (pytest-snapshot) {#snapshot-python} | 505-512 |
| &nbsp;&nbsp;TypeScript (vitest/jest) {#snapshot-typescript} | 513-521 |
| &nbsp;&nbsp;Snapshot Best Practices {#snapshot-best-practices} | 522-542 |
| Navigation {#navigation} | 543-550 |
