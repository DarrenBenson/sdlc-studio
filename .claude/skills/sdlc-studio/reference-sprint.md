...
**Reading Guide** - 855 lines, 21 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.
...
| Invocation | 48-75 |
| The loop | 76-335 |
| Definition of Done | 336-351 |
| Goals | 352-364 |
| &nbsp;&nbsp;`--goal plan` - sprint planning | 365-436 |
| &nbsp;&nbsp;`--goal design` - establish the dependency graph | 437-447 |
| The breakdown gate - `plan` refuses an ungroomed batch {#breakdown} | 448-501 |
| What the plan critic cannot see | 502-524 |
| Authoring mode - greenfield, from a PRD | 525-557 |
| The single-writer rule {#single-writer} | 558-583 |
| Guardrails | 584-603 |
| Autonomous mode (`--autonomous`) | 604-624 |
| The Two Instruments: Schedule and Cost {#schedule-and-cost} | 625-667 |
| Appetite (the run-level circuit breaker) {#appetite} | 668-729 |
| Rolling multi-sprint policy {#rolling} | 730-755 |
| Model-tier routing {#model-tier-routing} | 756-788 |
| Scripts | 789-808 |
| In-flight controls {#in-flight-controls} | 809-834 |
| Nothing is fixed during a close {#close-fixed-point} | 835-850 |
| See Also | 851-855 |
