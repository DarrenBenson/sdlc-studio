...
**Reading Guide** - 571 lines, 16 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Coverage Targets and Rationale | 32-33 |
| &nbsp;&nbsp;Default Targets | 34-41 |
| &nbsp;&nbsp;Why 90%? | 42-52 |
| &nbsp;&nbsp;Language-Agnostic Principles | 53-64 |
| &nbsp;&nbsp;Test Runner Recommendations (Not Mandates) | 65-78 |
| Test Organisation (Language-Agnostic) | 79-112 |
| Status Dashboard Workflow | 113-114 |
| &nbsp;&nbsp;/sdlc-studio status - Visual Dashboard | 115-151 |
| &nbsp;&nbsp;Step-by-Step Implementation | 152-347 |
| &nbsp;&nbsp;Cache-Aware Status Workflow | 348-412 |
| &nbsp;&nbsp;Output Format Rules (CRITICAL - MUST FOLLOW) | 413-453 |
| TSD Workflows | 454-455 |
| &nbsp;&nbsp;/sdlc-studio tsd - Step by Step | 456-489 |
| &nbsp;&nbsp;/sdlc-studio tsd generate - Step by Step | 490-515 |
| &nbsp;&nbsp;/sdlc-studio tsd review - Step by Step {#tsd-review-workflow} | 516-563 |
| See Also | 564-571 |
