...
**Reading Guide** - 567 lines, 39 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Overview | 55-82 |
| &nbsp;&nbsp;Two roles: adversarial reviewer vs reviewer of record | 83-117 |
| &nbsp;&nbsp;Document-owner seats | 118-133 |
| Integration Points | 134-135 |
| Summary Table | 136-153 |
| &nbsp;&nbsp;Refine and triage: the baked-in consult | 154-173 |
| Flags | 174-175 |
| Control Flags | 176-183 |
| Depth Flags | 184-192 |
| Per-Workflow Integration | 193-194 |
| PRD Workflows {#prd-integration} | 195-196 |
| &nbsp;&nbsp;PRD Create | 197-223 |
| &nbsp;&nbsp;PRD Generate | 224-236 |
| &nbsp;&nbsp;PRD Review | 237-250 |
| Epic Workflows {#epic-integration} | 251-252 |
| &nbsp;&nbsp;Epic Create | 253-280 |
| &nbsp;&nbsp;Epic Review | 281-290 |
| Story Workflows {#story-integration} | 291-292 |
| &nbsp;&nbsp;Story Create | 293-319 |
| &nbsp;&nbsp;Story Plan | 320-343 |
| &nbsp;&nbsp;Story Review | 344-361 |
| &nbsp;&nbsp;Bug Fix | 362-387 |
| Technical Workflows {#technical-integration} | 388-389 |
| &nbsp;&nbsp;TRD Create/Generate | 390-406 |
| &nbsp;&nbsp;Spec Review | 407-418 |
| Cost Considerations {#cost} | 419-420 |
| When Consultation Adds Most Value | 421-434 |
| Cost Reduction Strategies | 435-455 |
| Automatic vs Manual Consultation | 456-457 |
| Automatic (Built into Workflow) | 458-470 |
| Manual (User-Initiated) | 471-487 |
| Persona Relevance Mapping | 488-489 |
| Which Personas for Which Artefacts | 490-502 |
| Auto-Selection Logic | 503-513 |
| Configuration | 514-515 |
| Project-Level Defaults | 516-536 |
| Per-Command Override | 537-550 |
| See Also | 551-560 |
| Navigation | 561-567 |
