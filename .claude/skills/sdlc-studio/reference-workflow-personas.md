...
**Reading Guide** - 563 lines, 39 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Overview | 55-82 |
| &nbsp;&nbsp;Two roles: adversarial reviewer vs reviewer of record | 83-113 |
| &nbsp;&nbsp;Document-owner seats | 114-129 |
| Integration Points | 130-131 |
| Summary Table | 132-149 |
| &nbsp;&nbsp;Refine and triage: the baked-in consult | 150-169 |
| Flags | 170-171 |
| Control Flags | 172-179 |
| Depth Flags | 180-188 |
| Per-Workflow Integration | 189-190 |
| PRD Workflows {#prd-integration} | 191-192 |
| &nbsp;&nbsp;PRD Create | 193-219 |
| &nbsp;&nbsp;PRD Generate | 220-232 |
| &nbsp;&nbsp;PRD Review | 233-246 |
| Epic Workflows {#epic-integration} | 247-248 |
| &nbsp;&nbsp;Epic Create | 249-276 |
| &nbsp;&nbsp;Epic Review | 277-286 |
| Story Workflows {#story-integration} | 287-288 |
| &nbsp;&nbsp;Story Create | 289-315 |
| &nbsp;&nbsp;Story Plan | 316-339 |
| &nbsp;&nbsp;Story Review | 340-357 |
| &nbsp;&nbsp;Bug Fix | 358-383 |
| Technical Workflows {#technical-integration} | 384-385 |
| &nbsp;&nbsp;TRD Create/Generate | 386-402 |
| &nbsp;&nbsp;Spec Review | 403-414 |
| Cost Considerations {#cost} | 415-416 |
| When Consultation Adds Most Value | 417-430 |
| Cost Reduction Strategies | 431-451 |
| Automatic vs Manual Consultation | 452-453 |
| Automatic (Built into Workflow) | 454-466 |
| Manual (User-Initiated) | 467-483 |
| Persona Relevance Mapping | 484-485 |
| Which Personas for Which Artefacts | 486-498 |
| Auto-Selection Logic | 499-509 |
| Configuration | 510-511 |
| Project-Level Defaults | 512-532 |
| Per-Command Override | 533-546 |
| See Also | 547-556 |
| Navigation | 557-563 |
...
- **Adversarial reviewer** (the seat subagent): always runs; its pass is recorded as the
  unit's **delivery verdict** - verdict, findings, reviewer seat, author - with `critic.py
  record` (or `--from-verdict` to capture the returned block). The verdict is input to the
  run's signature, never the signature.
...
The batch verb (`record`) takes a whole batch in one invocation: `--units ID,ID` names them,
