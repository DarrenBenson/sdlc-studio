...
id: LL0043
title: An enumeration of a rule is a lower bound, not a boundary
tags: [documentation, testing]
added: 2026-07-22
origin: RUN-01KY3MFX
---

**Lesson.** A hand-maintained list describing what a mechanism catches will be wrong the moment the mechanism moves, and it reads as complete. One escape enumeration in RUN-01KY3MFX was wrong at three, four, five, six and seven items - five consecutive rounds each found one the previous list had explicitly DENIED. Derive the disclosure from the mechanism, or generate the corpus; do not hand-count it.
