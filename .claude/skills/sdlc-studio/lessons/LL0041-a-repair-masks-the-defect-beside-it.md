...
id: LL0041
title: A repair masks the defect beside it
tags: [review, mutation]
added: 2026-07-22
origin: RUN-01KY3MFX
---

**Lesson.** If a mutant SURVIVES, re-test that branch in isolation before concluding anything - a survivor is often evidence about the harness, not about the test. Hit three times in one sprint: un-stubbing a gate hid two hook mutants; removing the hook's traversal branch left the end-to-end test green because the fixture's gate stub refused the record for its own reason.
