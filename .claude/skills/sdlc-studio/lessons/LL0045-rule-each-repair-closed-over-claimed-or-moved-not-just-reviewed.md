...
id: LL0045
title: Rule each repair CLOSED, OVER-CLAIMED or MOVED, not just reviewed
tags: [review, process]
added: 2026-07-22
origin: RUN-01KY3MFX
---

**Lesson.** Brief a repair review with the previous round's findings enumerated and require a per-item verdict. On RUN-01KY3MFX this produced the single most useful artefact of the sprint - 5 closed, 3 over-claimed, 3 moved - where a general 'review the repair' brief would have blurred all three into one impression.
