...
**Reading Guide** - 819 lines, 37 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Contents | 49-64 |
| Overview | 65-74 |
| When to Run a Unified Review | 75-95 |
| /sdlc-studio review - Step by Step {#review-workflow} | 96-97 |
| &nbsp;&nbsp;1. Parse Arguments | 98-118 |
| &nbsp;&nbsp;2. Run Document Reviews | 119-197 |
| &nbsp;&nbsp;3. Cross-Document Consistency Check | 198-272 |
| &nbsp;&nbsp;3a. Persona Consultation (default when personas exist) | 273-290 |
| &nbsp;&nbsp;3b. Auto-Apply Mechanical Fixes | 291-318 |
| &nbsp;&nbsp;4. Close the Review (tool-carried) | 319-344 |
| &nbsp;&nbsp;5. Generate Consolidated Report | 345-400 |
| The adversarial closing-review brief {#closing-review-brief} | 401-409 |
| &nbsp;&nbsp;The claim inventory runs first | 410-431 |
| &nbsp;&nbsp;The standing review practices | 432-455 |
| &nbsp;&nbsp;Where a delegated reviewer mutates {#mutation-isolation} | 456-491 |
| Correcting the verdict log {#superseding-a-verdict} | 492-528 |
| &nbsp;&nbsp;What a superseded row does to the gates | 529-544 |
| Quick Mode | 545-563 |
| Focus Mode | 564-616 |
| TSD Review Workflow (Detailed) {#tsd-review-workflow} | 617-618 |
| &nbsp;&nbsp;1. Load TSD | 619-627 |
| &nbsp;&nbsp;2. Analyse Current Testing State | 628-646 |
| &nbsp;&nbsp;3. Identify Gaps | 647-657 |
| &nbsp;&nbsp;3a. Validate Test Organisation Tree | 658-671 |
| &nbsp;&nbsp;4. Update TSD | 672-682 |
| &nbsp;&nbsp;5. Report Strategy Currency | 683-694 |
| Cross-Document Rules | 695-696 |
| &nbsp;&nbsp;PRD → TRD Mapping | 697-704 |
| &nbsp;&nbsp;TRD → TSD Mapping | 705-712 |
| &nbsp;&nbsp;PRD NFR → TSD Gate Mapping | 713-721 |
| &nbsp;&nbsp;PRD → Persona Mapping | 722-731 |
| &nbsp;&nbsp;Persona → Artefact Activity Mapping | 732-743 |
| Review Output Formats | 744-745 |
| &nbsp;&nbsp;Console Output (Default) | 746-749 |
| &nbsp;&nbsp;JSON Output (CI/CD) | 750-782 |
| A disclosed sign-off is not an independent one | 783-811 |
| See Also | 812-819 |
