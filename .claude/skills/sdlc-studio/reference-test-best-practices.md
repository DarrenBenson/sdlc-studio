...
**Reading Guide** - 788 lines, 42 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Contents | 54-74 |
| Related References {#test-bp-related-references} | 75-96 |
| Anti-pattern: smoke → "fixed" {#smoke-fix-anti-pattern} | 97-108 |
| How to use the tiers in artefacts {#using-tiers} | 109-125 |
| 1. The vacuous / tautological assertion {#vacuous-assertion} | 126-160 |
| 2. The injected-data unit test that bypasses the real wiring {#injected-data-bypass} | 161-168 |
| The mutation check - the cheap proof your test can fail {#mutation-check} | 169-201 |
| Anti-patterns {#timeout-anti-patterns} | 202-208 |
| When the bump is legitimate {#timeout-bump-legitimate} | 209-218 |
| Why Higher Coverage Matters for AI Code {#why-higher-coverage-for-ai} | 219-231 |
| Complexity/churn-weighted test risk {#complexity-test-risk} | 232-252 |
| Review Patterns for AI Tests {#review-patterns-for-ai-tests} | 253-263 |
| Pre-Generation Analysis Checklist {#pre-generation-checklist} | 264-306 |
| Warning Policy {#warning-policy} | 307-310 |
| &nbsp;&nbsp;Why Warnings Matter {#why-warnings-matter} | 311-317 |
| &nbsp;&nbsp;Common Warning Types and Fixes {#common-warning-types} | 318-327 |
| &nbsp;&nbsp;Async/Database Test Fixture Pattern {#async-database-fixture-pattern} | 328-352 |
| &nbsp;&nbsp;Running Tests {#running-tests} | 353-369 |
| Test Writing Guidelines {#test-writing-guidelines} | 370-371 |
| &nbsp;&nbsp;Unicode and Encoding {#unicode-and-encoding} | 372-383 |
| &nbsp;&nbsp;Assertion Patterns {#assertion-patterns} | 384-411 |
| &nbsp;&nbsp;Model Instantiation {#model-instantiation} | 412-428 |
| &nbsp;&nbsp;Enum vs String {#enum-vs-string} | 429-443 |
| Frontend Testing Patterns (Vitest + React) {#frontend-testing-patterns} | 444-447 |
| &nbsp;&nbsp;Shared API Client Mock {#shared-api-mock} | 448-472 |
| &nbsp;&nbsp;Libraries That Need jsdom Mocking {#jsdom-mocking} | 473-503 |
| &nbsp;&nbsp;React Router Testing {#react-router-testing} | 504-522 |
| &nbsp;&nbsp;Dynamic Import Pattern for Mocked Modules {#dynamic-import-pattern} | 523-536 |
| &nbsp;&nbsp;Batch TDD for Frontend Components {#batch-tdd-frontend} | 537-552 |
| Coverage Verification {#coverage-verification} | 553-580 |
| Test Anti-Patterns to Avoid {#test-anti-patterns} | 581-586 |
| &nbsp;&nbsp;1. Over-Mocking (Mocking at Wrong Boundary) {#anti-pattern-over-mocking} | 587-610 |
| &nbsp;&nbsp;2. Framework Testing {#anti-pattern-framework-testing} | 611-625 |
| &nbsp;&nbsp;3. Time-Dependent Tests Without Mocking {#anti-pattern-time-dependent} | 626-653 |
| &nbsp;&nbsp;4. Tests That Always Pass {#anti-pattern-always-pass} | 654-674 |
| &nbsp;&nbsp;5. Mocking Everything in E2E Tests {#anti-pattern-mock-everything} | 675-694 |
| &nbsp;&nbsp;6. Skipping Contract Tests Between Layers {#anti-pattern-skip-contract-tests} | 695-714 |
| &nbsp;&nbsp;7. Conditional Assertions {#anti-pattern-conditional-assertions} | 715-732 |
| &nbsp;&nbsp;8. Silent Test Helpers {#anti-pattern-silent-helpers} | 733-756 |
| &nbsp;&nbsp;Integration test dependency checklist {#integration-dependency-checklist} | 757-769 |
| &nbsp;&nbsp;Debugging low coverage {#debugging-low-coverage} | 770-781 |
| See Also {#see-also} | 782-788 |
