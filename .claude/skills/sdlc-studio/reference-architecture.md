...
**Reading Guide** - 502 lines, 27 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Decision Tree {#decision-tree} | 47-66 |
| Project Types {#project-types} | 67-81 |
| Pattern-to-Project-Type Matrix {#pattern-to-project-type-matrix} | 82-92 |
| Start Simple Rule {#start-simple-rule} | 93-103 |
| Monolith {#monolith} | 104-134 |
| Modular Monolith {#modular-monolith} | 135-163 |
| Microservices {#microservices} | 164-197 |
| Serverless {#serverless} | 198-235 |
| Language Selection Matrix {#language-selection-matrix} | 236-247 |
| &nbsp;&nbsp;Recommendation by Project Type {#language-recommendation} | 248-258 |
| &nbsp;&nbsp;Weak Justifications to Avoid {#weak-justifications} | 259-266 |
| &nbsp;&nbsp;Strong Justifications {#strong-justifications} | 267-274 |
| Database Selection {#database-selection} | 275-285 |
| &nbsp;&nbsp;Default Recommendation {#database-default} | 286-302 |
| API Style Selection {#api-style-selection} | 303-311 |
| &nbsp;&nbsp;Default Recommendation {#database-default} | 312-326 |
| Pattern Detection {#pattern-detection} | 327-339 |
| Architecture Smell Detection {#architecture-smell-detection} | 340-354 |
| Assessment Output Format {#assessment-output-format} | 355-390 |
| Recommendation Workflow {#recommendation-workflow} | 391-410 |
| Key ADRs by Project Type {#key-adrs-by-project-type} | 411-414 |
| &nbsp;&nbsp;Web Application {#adrs-web-application} | 415-422 |
| &nbsp;&nbsp;API Backend {#adrs-api-backend} | 423-430 |
| &nbsp;&nbsp;Mobile Backend {#adrs-mobile-backend} | 431-438 |
| &nbsp;&nbsp;SDK/Library {#adrs-sdk-library} | 439-451 |
| REST API Checklist {#rest-api-checklist} | 452-465 |
| Error Response Standard {#error-response-standard} | 466-502 |
