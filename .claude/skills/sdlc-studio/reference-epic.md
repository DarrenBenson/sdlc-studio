...
**Reading Guide** - 1118 lines, 34 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Reading Guide | 48-62 |
| Epic Workflows | 63-74 |
| &nbsp;&nbsp;Resuming a partial epic (`epic implement --resume`) {#epic-implement-resume} | 75-85 |
| /sdlc-studio epic - Step by Step {#epic-workflow} | 86-152 |
| Perspective-Based Generation {#perspective-based-generation} | 153-160 |
| &nbsp;&nbsp;Engineering Perspective (--perspective engineering) {#perspective-engineering} | 161-203 |
| &nbsp;&nbsp;Product Perspective (--perspective product) {#perspective-product} | 204-244 |
| &nbsp;&nbsp;Test Perspective (--perspective test) {#perspective-test} | 245-294 |
| /sdlc-studio epic review - Step by Step {#epic-review-workflow} | 295-298 |
| &nbsp;&nbsp;Command Syntax | 299-313 |
| &nbsp;&nbsp;Cascade Workflow (Default) {#cascade-workflow} | 314-342 |
| &nbsp;&nbsp;Step-by-Step (Cascade Mode) | 343-454 |
| &nbsp;&nbsp;Quick Mode (--quick) {#quick-mode} | 455-475 |
| &nbsp;&nbsp;Resume Mode (--resume) {#resume-mode} | 476-492 |
| &nbsp;&nbsp;Review Queue Persistence {#review-queue} | 493-513 |
| &nbsp;&nbsp;Review State Tracking {#review-state-tracking} | 514-538 |
| Epic Section Reference | 539-544 |
| Workflow Commands | 545-548 |
| /sdlc-studio epic plan - Step by Step {#epic-plan-workflow} | 549-696 |
| /sdlc-studio epic implement - Step by Step {#epic-implement-workflow} | 697-902 |
| &nbsp;&nbsp;Post-Epic Completion Cascade {#post-epic-checklist} | 903-914 |
| Workflow Flags {#workflow-flags} | 915-916 |
| &nbsp;&nbsp;--story US000X {#flag-story} | 917-924 |
| &nbsp;&nbsp;--skip US000X {#flag-skip} | 925-932 |
| &nbsp;&nbsp;--agentic {#flag-agentic} | 933-968 |
| &nbsp;&nbsp;Default Agentic (with artifacts) {#agentic-with-artifacts} | 969-985 |
| &nbsp;&nbsp;--no-artifacts {#flag-no-artifacts} | 986-1023 |
| &nbsp;&nbsp;Quality Gates at Wave Boundaries {#wave-quality-gates} | 1024-1035 |
| Agent Prompt Template {#agent-prompt-template} | 1036-1044 |
| Epic Workflow Error Handling {#epic-workflow-error-handling} | 1045-1046 |
| &nbsp;&nbsp;Error Types {#error-types} | 1047-1057 |
| &nbsp;&nbsp;Recovery Strategies {#recovery-strategies} | 1058-1085 |
| See Also | 1086-1098 |
| Navigation {#navigation} | 1099-1118 |
