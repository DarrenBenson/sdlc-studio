...
**Reading Guide** - 1102 lines, 33 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Epic Workflows | 47-58 |
| &nbsp;&nbsp;Resuming a partial epic (`epic implement --resume`) {#epic-implement-resume} | 59-69 |
| /sdlc-studio epic - Step by Step {#epic-workflow} | 70-136 |
| Perspective-Based Generation {#perspective-based-generation} | 137-144 |
| &nbsp;&nbsp;Engineering Perspective (--perspective engineering) {#perspective-engineering} | 145-187 |
| &nbsp;&nbsp;Product Perspective (--perspective product) {#perspective-product} | 188-228 |
| &nbsp;&nbsp;Test Perspective (--perspective test) {#perspective-test} | 229-278 |
| /sdlc-studio epic review - Step by Step {#epic-review-workflow} | 279-282 |
| &nbsp;&nbsp;Command Syntax | 283-297 |
| &nbsp;&nbsp;Cascade Workflow (Default) {#cascade-workflow} | 298-326 |
| &nbsp;&nbsp;Step-by-Step (Cascade Mode) | 327-438 |
| &nbsp;&nbsp;Quick Mode (--quick) {#quick-mode} | 439-459 |
| &nbsp;&nbsp;Resume Mode (--resume) {#resume-mode} | 460-476 |
| &nbsp;&nbsp;Review Queue Persistence {#review-queue} | 477-497 |
| &nbsp;&nbsp;Review State Tracking {#review-state-tracking} | 498-522 |
| Epic Section Reference | 523-528 |
| Workflow Commands | 529-532 |
| /sdlc-studio epic plan - Step by Step {#epic-plan-workflow} | 533-680 |
| /sdlc-studio epic implement - Step by Step {#epic-implement-workflow} | 681-886 |
| &nbsp;&nbsp;Post-Epic Completion Cascade {#post-epic-checklist} | 887-898 |
| Workflow Flags {#workflow-flags} | 899-900 |
| &nbsp;&nbsp;--story US000X {#flag-story} | 901-908 |
| &nbsp;&nbsp;--skip US000X {#flag-skip} | 909-916 |
| &nbsp;&nbsp;--agentic {#flag-agentic} | 917-952 |
| &nbsp;&nbsp;Default Agentic (with artifacts) {#agentic-with-artifacts} | 953-969 |
| &nbsp;&nbsp;--no-artifacts {#flag-no-artifacts} | 970-1007 |
| &nbsp;&nbsp;Quality Gates at Wave Boundaries {#wave-quality-gates} | 1008-1019 |
| Agent Prompt Template {#agent-prompt-template} | 1020-1028 |
| Epic Workflow Error Handling {#epic-workflow-error-handling} | 1029-1030 |
| &nbsp;&nbsp;Error Types {#error-types} | 1031-1041 |
| &nbsp;&nbsp;Recovery Strategies {#recovery-strategies} | 1042-1069 |
| See Also | 1070-1082 |
| Navigation {#navigation} | 1083-1102 |
