...
**Reading Guide** - 523 lines, 30 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.
...
| migrate - one pass over everything {#migrate} | 86-104 |
| Schema Versions | 105-113 |
| Two-backlog model migration {#two-backlog-migration} | 114-140 |
| Version Check (hint and status only) | 141-144 |
| &nbsp;&nbsp;Dismissal File | 145-160 |
| Version Detection | 161-162 |
| &nbsp;&nbsp;On Any Command | 163-173 |
| &nbsp;&nbsp;Upgrade Suggestion Output | 174-182 |
| /sdlc-studio upgrade - Step by Step {#upgrade-workflow} | 183-184 |
| &nbsp;&nbsp;1. Parse Arguments | 185-192 |
| &nbsp;&nbsp;2. Detect Current Version | 193-204 |
| &nbsp;&nbsp;3. Inventory Existing Artifacts | 205-222 |
| &nbsp;&nbsp;4. Transform Each Artifact | 223-279 |
| &nbsp;&nbsp;5. Preserve During Transform | 280-296 |
| &nbsp;&nbsp;6. Update Index Files | 297-305 |
| &nbsp;&nbsp;7. Write Version File | 306-317 |
| &nbsp;&nbsp;8. Generate Report | 318-351 |
| Dry Run Output | 352-383 |
| /sdlc-studio project upgrade - convention migration {#project-upgrade-workflow} | 384-395 |
| &nbsp;&nbsp;Re-baseline: in-flight artefacts vs the capability delta {#rebaseline} | 396-450 |
| &nbsp;&nbsp;v3.1 default amigo cards (seat-aware, greenfield-only) | 451-477 |
| Backward Compatibility | 478-479 |
| &nbsp;&nbsp;v2 Skill Reading v1 Artifacts | 480-488 |
| &nbsp;&nbsp;Upgrade Is Optional | 489-497 |
| Configuration Upgrade | 498-508 |
| Rollback | 509-518 |
| See Also | 519-523 |
