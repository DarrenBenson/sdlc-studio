...
**Reading Guide** - 527 lines, 30 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.
...
| &nbsp;&nbsp;Re-baseline: in-flight artefacts vs the capability delta {#rebaseline} | 396-454 |
| &nbsp;&nbsp;v3.1 default amigo cards (seat-aware, greenfield-only) | 455-481 |
| Backward Compatibility | 482-483 |
| &nbsp;&nbsp;v2 Skill Reading v1 Artifacts | 484-492 |
| &nbsp;&nbsp;Upgrade Is Optional | 493-501 |
| Configuration Upgrade | 502-512 |
| Rollback | 513-522 |
| See Also | 523-527 |
