...
**Reading Guide** - 513 lines, 29 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Contents | 41-55 |
| The commands called "upgrade" {#three-upgrades} | 56-71 |
| migrate - one pass over everything {#migrate} | 72-90 |
| Schema Versions | 91-99 |
| Two-backlog model migration {#two-backlog-migration} | 100-126 |
| Version Check (hint and status only) | 127-130 |
| &nbsp;&nbsp;Dismissal File | 131-146 |
| Version Detection | 147-148 |
| &nbsp;&nbsp;On Any Command | 149-159 |
| &nbsp;&nbsp;Upgrade Suggestion Output | 160-168 |
| /sdlc-studio upgrade - Step by Step {#upgrade-workflow} | 169-170 |
| &nbsp;&nbsp;1. Parse Arguments | 171-178 |
| &nbsp;&nbsp;2. Detect Current Version | 179-190 |
| &nbsp;&nbsp;3. Inventory Existing Artifacts | 191-208 |
| &nbsp;&nbsp;4. Transform Each Artifact | 209-265 |
| &nbsp;&nbsp;5. Preserve During Transform | 266-282 |
| &nbsp;&nbsp;6. Update Index Files | 283-291 |
| &nbsp;&nbsp;7. Write Version File | 292-303 |
| &nbsp;&nbsp;8. Generate Report | 304-337 |
| Dry Run Output | 338-369 |
| /sdlc-studio project upgrade - convention migration {#project-upgrade-workflow} | 370-381 |
| &nbsp;&nbsp;Re-baseline: in-flight artefacts vs the capability delta {#rebaseline} | 382-440 |
| &nbsp;&nbsp;v3.1 default amigo cards (seat-aware, greenfield-only) | 441-467 |
| Backward Compatibility | 468-469 |
| &nbsp;&nbsp;v2 Skill Reading v1 Artifacts | 470-478 |
| &nbsp;&nbsp;Upgrade Is Optional | 479-487 |
| Configuration Upgrade | 488-498 |
| Rollback | 499-508 |
| See Also | 509-513 |
