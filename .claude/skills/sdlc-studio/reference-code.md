...
**Reading Guide** - 974 lines, 28 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Contents | 40-70 |
| Detailed Workflows {#detailed-workflows} | 71-72 |
| /sdlc-studio code plan - Step by Step {#code-plan-workflow} | 73-250 |
| /sdlc-studio code implement - Step by Step {#code-implementation-workflow} | 251-439 |
| /sdlc-studio code verify - Step by Step {#code-verify-workflow} | 440-531 |
| /sdlc-studio code check - Step by Step {#code-check-workflow} | 532-597 |
| /sdlc-studio code test - Step by Step {#code-test-workflow} | 598-729 |
| TDD vs Test-After {#tdd-vs-test-after} | 730-737 |
| Ship-Time Contract Sync {#ship-time-contract-sync} | 738-758 |
| Release-Strategy Branch {#release-strategy-branch} | 759-762 |
| &nbsp;&nbsp;`solo-dev` | 763-776 |
| &nbsp;&nbsp;`pr-required` | 777-786 |
| &nbsp;&nbsp;`staged-rollout` | 787-804 |
| Status Update Flow {#status-update-flow} | 805-836 |
| Best Practices Integration {#best-practices-integration} | 837-838 |
| Python Projects {#python-projects} | 839-847 |
| TypeScript Projects {#typescript-projects} | 848-856 |
| Go Projects {#go-projects} | 857-864 |
| Rust Projects {#rust-projects} | 865-874 |
| Error Handling {#error-handling} | 875-876 |
| Code Plan Errors {#code-plan-errors} | 877-886 |
| Code Implement Errors {#code-implement-errors} | 887-901 |
| Code Review Errors {#code-review-errors} | 902-909 |
| Code Check Errors {#code-check-errors} | 910-917 |
| Test Errors {#test-errors} | 918-927 |
| Workflow Orchestration {#workflow-orchestration} | 928-939 |
| See Also | 940-951 |
| Navigation {#navigation} | 952-974 |
