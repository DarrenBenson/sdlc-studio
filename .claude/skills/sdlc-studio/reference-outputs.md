...
**Reading Guide** - 869 lines, 43 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Contents | 55-73 |
| Output Formats {#output-formats} | 74-91 |
| Status Transitions {#status-transitions} | 92-93 |
| &nbsp;&nbsp;Epic Status Flow {#epic-status-flow} | 94-110 |
| &nbsp;&nbsp;Story Status Flow {#story-status-flow} | 111-134 |
| &nbsp;&nbsp;Compressed Status Flow (Agentic Batch Mode) {#compressed-status-flow} | 135-155 |
| &nbsp;&nbsp;Plan Status Flow {#plan-status-flow} | 156-167 |
| &nbsp;&nbsp;Bug Status Flow {#bug-status-flow} | 168-192 |
| &nbsp;&nbsp;Change Request Status Flow {#cr-status-flow} | 193-212 |
| &nbsp;&nbsp;RFC Status Flow {#rfc-status-flow} | 213-230 |
| &nbsp;&nbsp;Test Spec Status Flow {#test-spec-status-flow} | 231-243 |
| &nbsp;&nbsp;Workflow Status Flow {#workflow-status-flow} | 244-265 |
| Status Vocabulary Enforcement {#status-vocabulary} | 266-282 |
| &nbsp;&nbsp;Project-Level Document Exemptions {#project-level-exemptions} | 283-296 |
| ID Collision Prevention {#id-collision-prevention} | 297-317 |
| File Naming Conventions {#file-naming} | 318-319 |
| &nbsp;&nbsp;ID Formats {#id-formats} | 320-334 |
| &nbsp;&nbsp;Filename Patterns {#filename-patterns} | 335-361 |
| Index Files {#index-files} | 362-365 |
| &nbsp;&nbsp;Index File Location {#index-location} | 366-378 |
| &nbsp;&nbsp;Index File Structure {#index-structure} | 379-400 |
| &nbsp;&nbsp;Index File Maintenance {#index-maintenance} | 401-415 |
| &nbsp;&nbsp;Progressive disclosure: archival {#index-archival} | 416-445 |
| &nbsp;&nbsp;Slice-read large indexes {#index-slice-read} | 446-452 |
| Metadata Header Standards {#frontmatter} | 453-473 |
| Traceability {#traceability} | 474-506 |
| Review State Files {#review-state} | 507-510 |
| &nbsp;&nbsp;review-state.json {#review-state-json} | 511-564 |
| &nbsp;&nbsp;review-queue.json {#review-queue-json} | 565-598 |
| &nbsp;&nbsp;Modified-Since Detection {#modified-since-detection} | 599-617 |
| &nbsp;&nbsp;Backward Compatibility {#review-backward-compatibility} | 618-623 |
| Local State Files {#local-state} | 624-642 |
| &nbsp;&nbsp;upgrade-dismissed.json {#upgrade-dismissed-json} | 643-671 |
| Review Findings {#review-findings} | 672-681 |
| Validation Checklists {#validation-checklists} | 682-685 |
| &nbsp;&nbsp;Story Ready Checklist {#story-ready-checklist} | 686-695 |
| &nbsp;&nbsp;Story Quality Checklist {#story-quality-checklist} | 696-710 |
| &nbsp;&nbsp;Architecture Checklist {#architecture-checklist} | 711-738 |
| &nbsp;&nbsp;Story Completion Cascade Checklist {#story-completion-cascade} | 739-790 |
| &nbsp;&nbsp;Epic Completion Cascade Checklist {#epic-completion-cascade} | 791-818 |
| Changelog Fragments {#changelog-fragments} | 819-837 |
| Version Schema {#version-schema} | 838-860 |
| See Also | 861-869 |
