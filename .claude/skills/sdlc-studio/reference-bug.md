...
**Reading Guide** - 554 lines, 43 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Bug Tracking Workflows | 59-60 |
| /sdlc-studio bug create - Step by Step {#bug-create-workflow} | 61-108 |
| /sdlc-studio bug list - Step by Step {#bug-list-workflow} | 109-143 |
| /sdlc-studio bug fix --bug BG{NNNN} - Step by Step {#bug-fix-workflow} | 144-204 |
| /sdlc-studio bug verify --bug BG{NNNN} - Step by Step {#bug-verify-workflow} | 205-253 |
| /sdlc-studio bug close --bug BG{NNNN} - Step by Step {#bug-close-workflow} | 254-294 |
| /sdlc-studio bug reopen --bug BG{NNNN} - Step by Step {#bug-reopen-workflow} | 295-325 |
| Bug Section Reference | 326-331 |
| Summary and Metadata {#summary-and-metadata} | 332-333 |
| &nbsp;&nbsp;Status Values {#status-values} | 334-340 |
| &nbsp;&nbsp;Severity Guide {#severity-guide} | 341-349 |
| &nbsp;&nbsp;Priority Guide {#priority-guide} | 350-360 |
| Affected Area {#affected-area} | 361-362 |
| &nbsp;&nbsp;Epic/Story Links {#epic-story-links} | 363-368 |
| &nbsp;&nbsp;Component {#component} | 369-375 |
| Reproduction Steps {#reproduction-steps} | 376-377 |
| &nbsp;&nbsp;Good Steps {#good-steps} | 378-384 |
| &nbsp;&nbsp;Example {#example} | 385-396 |
| Expected vs Actual {#expected-vs-actual} | 397-398 |
| &nbsp;&nbsp;Expected Behaviour {#expected-behaviour} | 399-404 |
| &nbsp;&nbsp;Actual Behaviour {#actual-behaviour} | 405-412 |
| Root Cause Analysis {#root-cause-analysis} | 413-414 |
| &nbsp;&nbsp;When to Fill {#when-to-fill} | 415-419 |
| &nbsp;&nbsp;What to Include {#root-cause-what-to-include} | 420-427 |
| Fix Description {#fix-description} | 428-429 |
| &nbsp;&nbsp;What to Include {#root-cause-what-to-include} | 430-436 |
| &nbsp;&nbsp;Files Modified Table {#files-modified-table} | 437-444 |
| Tests Added {#tests-added} | 445-446 |
| &nbsp;&nbsp;Purpose {#tests-purpose} | 447-451 |
| &nbsp;&nbsp;Table Format {#table-format} | 452-459 |
| Verification {#verification} | 460-461 |
| &nbsp;&nbsp;Checklist {#checklist} | 462-468 |
| &nbsp;&nbsp;Who Verifies {#who-verifies} | 469-476 |
| Related Items {#related-items} | 477-478 |
| &nbsp;&nbsp;What to Link {#what-to-link} | 479-484 |
| &nbsp;&nbsp;Duplicate Handling {#duplicate-handling} | 485-492 |
| Notes {#notes} | 493-494 |
| &nbsp;&nbsp;What to Include {#root-cause-what-to-include} | 495-503 |
| Revision History {#revision-history} | 504-505 |
| &nbsp;&nbsp;Required Entries {#required-entries} | 506-513 |
| &nbsp;&nbsp;Format {#revision-format} | 514-523 |
| See Also | 524-534 |
| Navigation {#navigation} | 535-554 |
