...
**Reading Guide** - 695 lines, 36 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.
...
| Review Configuration | 204-215 |
| &nbsp;&nbsp;The repair-plan gate {#repair-plan-gate} | 216-233 |
| Persona Staleness {#personas-staleness-days} | 234-245 |
| Lessons Validity {#lessons-validity} | 246-262 |
| Sprint Breakdown Gate {#breakdown} | 263-271 |
| Two-Backlog Enforcement {#two-backlog} | 272-281 |
| Sprint Capacity {#capacity} | 282-297 |
| Run Appetite {#appetite} | 298-310 |
| Skill Source Repo {#skill-source-repo} | 311-329 |
| Contract Tables {#contract-tables} | 330-345 |
| Release Strategy {#release-strategy} | 346-363 |
| Deploy Contract {#deploy} | 364-392 |
| Model-Tier Routing {#routing} | 393-421 |
| Plan-Review Gate {#plan-review} | 422-445 |
| Spec-Edit Guard {#spec-guard} | 446-468 |
| Using Config in Templates | 469-481 |
| Example Project Config | 482-535 |
| Conventions (tolerant convention layer) | 536-574 |
| Version File | 575-595 |
| &nbsp;&nbsp;Schema version stamp {#schema-version} | 596-616 |
| &nbsp;&nbsp;Schema v3 triage lane {#triage-vocab} | 617-653 |
| Pipeline Profile {#profile} | 654-676 |
| Project Implementation | 677-689 |
| See Also | 690-695 |
