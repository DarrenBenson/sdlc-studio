...
**Reading Guide** - 683 lines, 36 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Contents | 48-76 |
| Configuration Files | 77-84 |
| Configuration Loading | 85-102 |
| Coverage Targets | 103-116 |
| Story Quality Gates | 117-120 |
| &nbsp;&nbsp;Edge Cases | 121-129 |
| &nbsp;&nbsp;Test Scenarios | 130-136 |
| &nbsp;&nbsp;Story Sizing | 137-147 |
| Engagement Floor {#engagement-floor} | 148-163 |
| TDD Trigger | 164-175 |
| E2E Limits | 176-187 |
| Epic Perspectives | 188-203 |
| Review Configuration | 204-219 |
| &nbsp;&nbsp;Review gate cutoffs {#review-cutoffs} | 220-226 |
| Persona Staleness {#personas-staleness-days} | 227-238 |
| Lessons Validity {#lessons-validity} | 239-255 |
| Sprint Breakdown Gate {#breakdown} | 256-264 |
| Two-Backlog Enforcement {#two-backlog} | 265-274 |
| Sprint Capacity {#capacity} | 275-290 |
| Run Appetite {#appetite} | 291-303 |
| Skill Source Repo {#skill-source-repo} | 304-322 |
| Contract Tables {#contract-tables} | 323-338 |
| Release Strategy {#release-strategy} | 339-356 |
| Deploy Contract {#deploy} | 357-385 |
| Model-Tier Routing {#routing} | 386-415 |
| Plan-Review Gate {#plan-review} | 416-439 |
| Spec-Edit Guard {#spec-guard} | 440-462 |
| Using Config in Templates | 463-475 |
| Example Project Config | 476-523 |
| Conventions (tolerant convention layer) | 524-562 |
| Version File | 563-583 |
| &nbsp;&nbsp;Schema version stamp {#schema-version} | 584-604 |
| &nbsp;&nbsp;Schema v3 triage lane {#triage-vocab} | 605-641 |
| Pipeline Profile {#profile} | 642-664 |
| Project Implementation | 665-677 |
| See Also | 678-683 |
