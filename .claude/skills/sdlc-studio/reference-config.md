...
**Reading Guide** - 728 lines, 38 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Contents | 50-78 |
| Configuration Files | 79-86 |
| Configuration Loading | 87-104 |
| Coverage Targets | 105-118 |
| Story Quality Gates | 119-122 |
| &nbsp;&nbsp;Edge Cases | 123-131 |
| &nbsp;&nbsp;Test Scenarios | 132-138 |
| &nbsp;&nbsp;Story Sizing | 139-149 |
| Engagement Floor {#engagement-floor} | 150-165 |
| TDD Trigger | 166-177 |
| E2E Limits | 178-189 |
| Epic Perspectives | 190-205 |
| Review Configuration | 206-217 |
| &nbsp;&nbsp;Review gate cutoffs {#review-cutoffs} | 218-224 |
| &nbsp;&nbsp;The plan falsifiability gate {#plan-falsifiability} | 225-248 |
| &nbsp;&nbsp;The repair-plan gate {#repair-plan-gate} | 249-266 |
| Persona Staleness {#personas-staleness-days} | 267-278 |
| Lessons Validity {#lessons-validity} | 279-295 |
| Sprint Breakdown Gate {#breakdown} | 296-304 |
| Two-Backlog Enforcement {#two-backlog} | 305-314 |
| Sprint Capacity {#capacity} | 315-330 |
| Run Appetite {#appetite} | 331-343 |
| Skill Source Repo {#skill-source-repo} | 344-362 |
| Contract Tables {#contract-tables} | 363-378 |
| Release Strategy {#release-strategy} | 379-396 |
| Deploy Contract {#deploy} | 397-425 |
| Model-Tier Routing {#routing} | 426-454 |
| Plan-Review Gate {#plan-review} | 455-478 |
| Spec-Edit Guard {#spec-guard} | 479-501 |
| Using Config in Templates | 502-514 |
| Example Project Config | 515-568 |
| Conventions (tolerant convention layer) | 569-607 |
| Version File | 608-628 |
| &nbsp;&nbsp;Schema version stamp {#schema-version} | 629-649 |
| &nbsp;&nbsp;Schema v3 triage lane {#triage-vocab} | 650-686 |
| Pipeline Profile {#profile} | 687-709 |
| Project Implementation | 710-722 |
| See Also | 723-728 |
