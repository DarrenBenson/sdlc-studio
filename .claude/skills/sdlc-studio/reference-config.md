...
**Reading Guide** - 720 lines, 37 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.
...
| Review Configuration | 205-216 |
| &nbsp;&nbsp;The plan falsifiability gate {#plan-falsifiability} | 217-240 |
| &nbsp;&nbsp;The repair-plan gate {#repair-plan-gate} | 241-258 |
| Persona Staleness {#personas-staleness-days} | 259-270 |
| Lessons Validity {#lessons-validity} | 271-287 |
| Sprint Breakdown Gate {#breakdown} | 288-296 |
| Two-Backlog Enforcement {#two-backlog} | 297-306 |
| Sprint Capacity {#capacity} | 307-322 |
| Run Appetite {#appetite} | 323-335 |
| Skill Source Repo {#skill-source-repo} | 336-354 |
| Contract Tables {#contract-tables} | 355-370 |
| Release Strategy {#release-strategy} | 371-388 |
| Deploy Contract {#deploy} | 389-417 |
| Model-Tier Routing {#routing} | 418-446 |
| Plan-Review Gate {#plan-review} | 447-470 |
| Spec-Edit Guard {#spec-guard} | 471-493 |
| Using Config in Templates | 494-506 |
| Example Project Config | 507-560 |
| Conventions (tolerant convention layer) | 561-599 |
| Version File | 600-620 |
| &nbsp;&nbsp;Schema version stamp {#schema-version} | 621-641 |
| &nbsp;&nbsp;Schema v3 triage lane {#triage-vocab} | 642-678 |
| Pipeline Profile {#profile} | 679-701 |
| Project Implementation | 702-714 |
| See Also | 715-720 |
