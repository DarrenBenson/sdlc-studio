...
**Reading Guide** - 660 lines, 35 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Contents | 47-75 |
| Configuration Files | 76-83 |
| Configuration Loading | 84-101 |
| Coverage Targets | 102-115 |
| Story Quality Gates | 116-119 |
| &nbsp;&nbsp;Edge Cases | 120-128 |
| &nbsp;&nbsp;Test Scenarios | 129-135 |
| &nbsp;&nbsp;Story Sizing | 136-146 |
| Engagement Floor {#engagement-floor} | 147-162 |
| TDD Trigger | 163-174 |
| E2E Limits | 175-186 |
| Epic Perspectives | 187-202 |
| Review Configuration | 203-218 |
| &nbsp;&nbsp;Review gate cutoffs {#review-cutoffs} | 219-227 |
| Persona Staleness {#personas-staleness-days} | 228-239 |
| Lessons Validity {#lessons-validity} | 240-256 |
| Sprint Breakdown Gate {#breakdown} | 257-265 |
| Two-Backlog Enforcement {#two-backlog} | 266-275 |
| Sprint Capacity {#capacity} | 276-291 |
| Run Appetite {#appetite} | 292-304 |
| Skill Source Repo {#skill-source-repo} | 305-323 |
| Contract Tables {#contract-tables} | 324-339 |
| Release Strategy {#release-strategy} | 340-357 |
| Deploy Contract {#deploy} | 358-386 |
| Model-Tier Routing {#routing} | 387-416 |
| Spec-Edit Guard {#spec-guard} | 417-439 |
| Using Config in Templates | 440-452 |
| Example Project Config | 453-500 |
| Conventions (tolerant convention layer) | 501-539 |
| Version File | 540-560 |
| &nbsp;&nbsp;Schema version stamp {#schema-version} | 561-581 |
| &nbsp;&nbsp;Schema v3 triage lane {#triage-vocab} | 582-618 |
| Pipeline Profile {#profile} | 619-641 |
| Project Implementation | 642-654 |
| See Also | 655-660 |
