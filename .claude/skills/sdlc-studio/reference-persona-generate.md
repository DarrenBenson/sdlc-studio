...
**Reading Guide** - 511 lines, 28 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| From PRD (`--from-prd`) {#from-prd} | 56-59 |
| &nbsp;&nbsp;Step 1: Analyse PRD | 60-71 |
| &nbsp;&nbsp;Step 2: Present Discoveries | 72-96 |
| &nbsp;&nbsp;Step 3: Interactive Enrichment | 97-138 |
| &nbsp;&nbsp;Step 4: Write Persona Files | 139-146 |
| From Codebase (`--from-code`) {#from-code} | 147-150 |
| &nbsp;&nbsp;Step 1: Analyse Codebase | 151-188 |
| &nbsp;&nbsp;Step 2: Present Discoveries | 189-217 |
| &nbsp;&nbsp;Step 3: Map to Personas | 218-244 |
| &nbsp;&nbsp;Step 4: Validate Against Archetypes | 245-260 |
| From Documentation (`--from-docs`) {#from-docs} | 261-264 |
| &nbsp;&nbsp;Step 1: Scan Documentation | 265-276 |
| &nbsp;&nbsp;Step 2: Present Discoveries | 277-301 |
| &nbsp;&nbsp;Step 3: Enrichment | 302-309 |
| Quick Mode (`--quick`) | 310-318 |
| Standard Mode (default) | 319-331 |
| Thorough Mode (`--thorough`) | 332-355 |
| `--team` {#team} | 356-357 |
| &nbsp;&nbsp;Step 1: Analyse (every source that exists; degrade honestly when absent) | 358-366 |
| &nbsp;&nbsp;Step 2: Ask when unsure - HARD-CAPPED at 4 questions (1 under `--quick`) | 367-383 |
| &nbsp;&nbsp;Step 3: Generate fresh named individuals | 384-403 |
| &nbsp;&nbsp;Step 4: Stamp, gate, accept | 404-416 |
| `--stakeholders` {#stakeholders} | 417-432 |
| Standalone invocation {#team-standalone} | 433-455 |
| File Structure | 456-468 |
| Persona File Header | 469-479 |
| Index Update | 480-498 |
| Navigation {#navigation} | 499-511 |
