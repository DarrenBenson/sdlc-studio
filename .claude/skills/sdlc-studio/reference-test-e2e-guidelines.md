...
**Reading Guide** - 554 lines, 26 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Contents | 42-70 |
| Related References {#e2e-related-references} | 71-83 |
| Feature Coverage Matrix {#feature-coverage-matrix} | 84-95 |
| Minimum Scenarios Per Feature {#minimum-scenarios-per-feature} | 96-104 |
| When to Create New Spec Files {#when-to-create-new-spec-files} | 105-118 |
| Critical: E2E Mocking Blindspot {#e2e-mocking-blindspot} | 119-130 |
| The API Contract Test Pattern {#api-contract-test-pattern} | 131-142 |
| Mock Boundary Principles {#mock-boundary-principles} | 143-144 |
| &nbsp;&nbsp;Mock at System Boundaries, Not Internal Libraries {#mock-at-system-boundaries} | 145-161 |
| Status Code Verification {#status-code-verification-python} | 162-175 |
| Contract Test Example {#contract-test-example-python} | 176-199 |
| Mocking Singletons (Global Variables) {#mocking-singletons} | 200-217 |
| Mocking Factory Functions (Dependency Injection) {#mocking-factory-functions} | 218-245 |
| Mock Objects with Attributes {#mock-objects-with-attributes} | 246-267 |
| Schema Version Verification {#schema-version-verification} | 268-291 |
| Contract Test Example {#contract-test-example-python} | 292-311 |
| E2E with Playwright and MSW {#e2e-playwright-msw} | 312-339 |
| Mocking with Jest/Vitest {#mocking-jest-vitest} | 340-353 |
| Status Code Verification {#status-code-verification-python} | 354-373 |
| Contract Test Example {#contract-test-example-python} | 374-401 |
| Mocking External Services {#mocking-external-services} | 402-429 |
| Time Mocking with Clockwork {#time-mocking-clockwork} | 430-460 |
| Frontend Test Structure {#frontend-test-structure} | 461-486 |
| Backend Test Structure {#backend-test-structure} | 487-508 |
| Go Test Structure {#go-test-structure} | 509-545 |
| Coverage Targets {#e2e-coverage-targets} | 546-554 |
