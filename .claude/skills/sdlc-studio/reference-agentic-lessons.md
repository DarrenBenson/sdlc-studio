...
**Reading Guide** - 491 lines, 43 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Exploration | 63-64 |
| &nbsp;&nbsp;Load project lessons before exploration | 65-74 |
| &nbsp;&nbsp;Explore once per epic, not per wave | 75-86 |
| &nbsp;&nbsp;Read, don't guess | 87-96 |
| Wave Structure | 97-98 |
| &nbsp;&nbsp;Wave 1 is always sequential | 99-108 |
| &nbsp;&nbsp;Two parallel stories per wave is the sweet spot | 109-112 |
| &nbsp;&nbsp;Put the complex story in its own wave | 113-116 |
| &nbsp;&nbsp;Commit every wave to main before launching the next wave's worktree agents | 117-122 |
| &nbsp;&nbsp;Single-agent-on-main is the default; parallel worktrees are the exception | 123-132 |
| &nbsp;&nbsp;Cherry-pick worktree branches by scope narrowness, not story points or id | 133-136 |
| &nbsp;&nbsp;Wave 1 forward-declares every shared type, interface, and hub-file addition | 137-142 |
| Agent Prompts | 143-144 |
| &nbsp;&nbsp;"DO NOT" sections prevent scope creep | 145-155 |
| &nbsp;&nbsp;"READ THESE FILES FIRST" is the most important section | 156-172 |
| &nbsp;&nbsp;Concrete beats abstract | 173-183 |
| &nbsp;&nbsp;Include code snippets for shapes, not logic | 184-189 |
| Hub Files and Merging | 190-191 |
| &nbsp;&nbsp;Hub file conflicts are the #1 merge issue | 192-201 |
| &nbsp;&nbsp;New files never conflict | 202-205 |
| &nbsp;&nbsp;Copy, don't merge | 206-215 |
| Quality and Drift | 216-217 |
| &nbsp;&nbsp;Per-wave reconcile is cheap but essential | 218-221 |
| &nbsp;&nbsp;Typecheck catches 80% of merge issues instantly | 222-225 |
| &nbsp;&nbsp;Test the merged code, not the worktree code | 226-231 |
| &nbsp;&nbsp;Small batches survive AI speed only if something watches the diff {#small-batch-guard} | 232-243 |
| Commits and Pacing | 244-245 |
| &nbsp;&nbsp;Per-epic commits are the sweet spot | 246-253 |
| &nbsp;&nbsp;Commit sdlc-studio changes separately | 254-257 |
| &nbsp;&nbsp;Review BEFORE the commit, not after | 258-280 |
| &nbsp;&nbsp;Don't skip the post-epic commit | 281-286 |
| Scale and Context | 287-288 |
| &nbsp;&nbsp;Context window management matters at project scale | 289-296 |
| &nbsp;&nbsp;Story generation is its own phase | 297-302 |
| Common Failure Modes | 303-316 |
| &nbsp;&nbsp;A delegate can stop without erroring {#silent-stall} | 317-345 |
| Lessons Accumulation {#lessons-accumulation} | 346-351 |
| &nbsp;&nbsp;Where lessons are stored | 352-357 |
| &nbsp;&nbsp;When lessons are recorded | 358-391 |
| &nbsp;&nbsp;The project tier is the default; `--global` is the promotion | 392-420 |
| &nbsp;&nbsp;The close loop is a mechanism, not doctrine {#close-loop} | 421-446 |
| &nbsp;&nbsp;File format | 447-477 |
| &nbsp;&nbsp;How lessons are consumed | 478-491 |
