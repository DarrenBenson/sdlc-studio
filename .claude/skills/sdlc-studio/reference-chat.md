...
**Reading Guide** - 518 lines, 27 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Single Persona Chat {#single-chat} | 56-63 |
| &nbsp;&nbsp;Workflow | 64-82 |
| &nbsp;&nbsp;System Prompt Structure | 83-121 |
| &nbsp;&nbsp;Example Session | 122-151 |
| Workshop Mode {#workshop} | 152-159 |
| &nbsp;&nbsp;Options | 160-168 |
| &nbsp;&nbsp;Workflow | 169-195 |
| &nbsp;&nbsp;Workshop Prompt Structure | 196-232 |
| &nbsp;&nbsp;Example Workshop | 233-271 |
| Context Loading {#context} | 272-283 |
| &nbsp;&nbsp;Context Integration | 284-296 |
| Starting a Session | 297-312 |
| During a Session | 313-329 |
| Ending a Session | 330-346 |
| Saving Transcripts | 347-380 |
| Requirements Discovery | 381-390 |
| Design Validation | 391-398 |
| Conflict Resolution | 399-406 |
| Mentoring/Learning | 407-416 |
| User Research Simulation | 417-430 |
| Consistency | 431-439 |
| Authenticity | 440-448 |
| Interaction Between Personas | 449-467 |
| When to Use Chat vs Consult | 468-478 |
| Effective Chat Sessions | 479-487 |
| Workshop Facilitation | 488-506 |
| Navigation | 507-518 |
