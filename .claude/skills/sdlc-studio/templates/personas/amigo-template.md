<!--
Template: Amigo card (enriched seat) - RFC0020 D4
Usage: Copy and customise for a Three Amigos seat (Engineering / QA / Product) that both DOES the
...
> separate instances** on one unit - a seat never reviews its own output (the independence gate).
...
touch and leave alone, how they end a unit. This is the disposition the build prompt borrows.}}
