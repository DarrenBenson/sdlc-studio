...
**Reading Guide** - 634 lines, 36 section(s). Generated by `docgen.py reading-guides`; read a span with `Read(offset, limit)` rather than the whole file.

| Section | Lines |
| --- | --- |
| Overview | 52-90 |
| Consultation Modes | 91-92 |
| Single Persona {#single-persona} | 93-107 |
| &nbsp;&nbsp;Workflow | 108-155 |
| Team Review (Three Amigos) {#team-review} | 156-163 |
| &nbsp;&nbsp;Default Team Selection | 164-173 |
| &nbsp;&nbsp;Workflow | 174-194 |
| &nbsp;&nbsp;Example Output | 195-251 |
| Stakeholder Review {#stakeholder-review} | 252-259 |
| &nbsp;&nbsp;Workflow | 260-283 |
| &nbsp;&nbsp;Example Output | 284-338 |
| All Personas {#all-personas} | 339-346 |
| &nbsp;&nbsp;Workflow | 347-357 |
| Multi-Persona Pressure-Test Canvas {#pressure-test-canvas} | 358-361 |
| &nbsp;&nbsp;When to trigger | 362-370 |
| &nbsp;&nbsp;How to conduct | 371-378 |
| &nbsp;&nbsp;Synthesis discipline | 379-392 |
| &nbsp;&nbsp;Canvas size | 393-403 |
| &nbsp;&nbsp;Anti-patterns | 404-412 |
| Options | 413-414 |
| Depth Control | 415-422 |
| Filtering | 423-430 |
| Team Override | 431-438 |
| Output | 439-448 |
| Relevance Scoring {#relevance} | 449-463 |
| Artefact-Specific Guidance {#artefact-guidance} | 464-465 |
| PRD Review | 466-481 |
| Epic Review | 482-496 |
| Story Review | 497-510 |
| Technical Spec Review | 511-526 |
| Integration Points {#integration} | 527-528 |
| Automatic Consultation (Workflow Integration) | 529-544 |
| Manual Integration | 545-559 |
| Consultation Prompt Template {#prompt-template} | 560-606 |
| See Also | 607-617 |
| Navigation {#navigation} | 618-634 |
