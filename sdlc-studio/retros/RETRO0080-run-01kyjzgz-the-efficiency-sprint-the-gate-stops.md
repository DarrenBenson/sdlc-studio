...
> **Date:** 2026-07-28
> **Batch:** RUN-01KYJZGZ - 33 units (15 stories, 18 bugs), 107 points: BG0345, BG0346, US0493, US0494, US0495, US0496, US0497, US0498, US0499, US0500, US0501, US0502, US0503, US0504, US0505, US0506, US0507, BG0348, BG0343, BG0344, BG0349, BG0335, BG0328, BG0330, BG0318, BG0312, BG0327, BG0337, BG0338, BG0339, BG0340, BG0334, BG0342
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BG0345 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0346 | 2 | 119,262 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0493 | 5 | 298,155 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0494 | 8 | 477,048 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0495 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0496 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0497 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0498 | 5 | 298,155 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0499 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0500 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0501 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0502 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0503 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0504 | 5 | 298,155 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0505 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0506 | 5 | 298,155 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0507 | 5 | 298,155 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0348 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0343 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0344 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0349 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0335 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0328 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0330 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0318 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0312 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0327 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0337 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0338 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0339 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0340 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0334 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0342 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| **Batch (rated units only)** | **0** | **0** | **0** | - | **-** | | **-** | - |

**0 of 33 unit(s) measured; 17 of 33 forecast at plan time.**
...
Unmeasured: BG0345, BG0346, US0493, US0494, US0495, US0496, US0497, US0498, US0499, US0500, US0501, US0502, US0503, US0504, US0505, US0506, US0507. They are excluded from the batch ratio - an unmeasured unit is not evidence that the estimate was right.
Unforecast: BG0348, BG0343, BG0344, BG0349, BG0335, BG0328, BG0330, BG0318, BG0312, BG0327, BG0337, BG0338, BG0339, BG0340, BG0334, BG0342. No plan-time forecast was recorded for them, so they are excluded too. The estimate is NOT re-derived from today's constants: a number computed at judgement time, by the model being judged, is not a prediction.
...
- Tokens: ~2.6M across delivery and review agents · Duration: delivery ~68 min of lane time across
  ...
  of writing
| 2026-07-28 | Claude Opus 5 | Batch line back-annotated with the unit ids from the archived run state (`sdlc-studio/.local/run-archive/RUN-01KYJZGZ.json`). The close DID happen and this retro is it; the line named the run and the counts in prose, so `retro.batch_ids` read zero units and `close_owed` could not attribute a single one of them - the same defect BG0362 describes. The ids are the run's own recorded batch, not a reconstruction. |
