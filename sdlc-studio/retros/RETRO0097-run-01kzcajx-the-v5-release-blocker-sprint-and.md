...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BG0516 | 3 | 133,281 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0521 | 3 | 133,281 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0524 | 2 | 88,854 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0530 | 5 | 222,135 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0533 | 5 | 222,135 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
...
| US0591 | 5 | 222,135 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0592 | 5 | 222,135 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0593 | 3 | 133,281 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0594 | 5 | 222,135 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0595 | 3 | 133,281 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0596 | 3 | 133,281 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0635 | 3 | 141,105 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0636 | 3 | 141,105 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| CR0535 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| **Batch (rated units only)** | **0** | **0** | **0** | - | **-** | | **-** | - |

**0 of 19 unit(s) measured; 18 of 19 forecast at plan time.**
...
Review passes, by phase - read from the two verdict ledgers:
  ...
  test-plan review: 23 pass(es) over 13 unit(s), 15 rejected

  code review: 17 pass(es) over 12 unit(s), 5 rejected

  ratio: 0.74 code-review pass(es) per test-plan pass - the claim EP0207 is judged on, as a number
Unmeasured: BG0516, BG0521, BG0524, BG0530, BG0533, US0564, US0565, US0566, US0567, US0573, US0591, US0592, US0593, US0594, US0595, US0596, US0635, US0636. They are excluded from the batch ratio - an unmeasured unit is not evidence that the estimate was right.
Unforecast: CR0535. No plan-time forecast was recorded for them, so they are excluded too. The estimate is NOT re-derived from today's constants: a number computed at judgement time, by the model being judged, is not a prediction.
...
- [HO-0054](../handoffs/HO0054-a-shipped-command-stops-reporting-a-success-it.md) - 9 remaining item(s): 0 copilot-tail, 9 judgement. Pick up with `sprint plan --worklist sdlc-studio/.local/handoff-worklist.txt`.
