...
**The red-now ledger, this rung's exit condition: 38 criteria, 0 pass, 38 fail, 0 manual, 0
unspecified.** Zero passing is the column that matters. A criterion that passes before its
