...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| US0671 | 5 | 189,435 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0672 | 3 | 113,661 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0673 | 2 | 75,774 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0674 | 3 | 113,661 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0675 | 5 | 189,435 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0676 | 3 | 113,661 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
...
Review passes, by phase - read from the two verdict ledgers:
  ...
  test-plan review: 11 pass(es) over 6 unit(s), 5 rejected

  code review: 22 pass(es) over 6 unit(s), 10 rejected

  ratio: 2.00 code-review pass(es) per test-plan pass - the claim EP0207 is judged on, as a number
Unmeasured: US0671, US0672, US0673, US0674, US0675, US0676. They are excluded from the batch ratio - an unmeasured unit is not evidence that the estimate was right.
...
- [HO-0062](../handoffs/HO0062-a-unit-s-own-evidence-is-made-honest.md) - 0 remaining item(s): 0 copilot-tail, 0 judgement. Pick up with `sprint plan --worklist sdlc-studio/.local/handoff-worklist.txt`.
