...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BG0504 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0503 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| BG0505 | - | - | - | **UNFORECAST** (no plan-time forecast recorded; no telemetry token record) | - | - | - | - |
| **Batch (rated units only)** | **0** | **0** | **0** | - | **-** | | **-** | - |

**0 of 3 unit(s) measured; 0 of 3 forecast at plan time.**
...
Review passes - read from the verdict ledger:
  ...
  code review: NOT IN FORCE for this run - no verdict covers any of its units, which is not the same as a run that held reviews and spent nothing
Unforecast: BG0504, BG0503, BG0505. No plan-time forecast was recorded for them, so they are excluded too. The estimate is NOT re-derived from today's constants: a number computed at judgement time, by the model being judged, is not a prediction.
