...
- **138 of 148 planned points delivered across 45 of 48 units.** Corrected at the close: the
  figure first written here, 143 across 47, counted BG0372 (2pts) and BG0359 (3pts), both of
  which were later REOPENED because they deliver nothing. A unit that delivers nothing cannot
  contribute its points, and a velocity series built from the claimed number would be 3% high
  for this sprint. BG0350, the original miss, is a deliberate drop rather than an overrun, so
  the estimate held on sizing: the batch was sized correctly and the one unit planned but not
  shipped was refused on evidence grounds rather than on capacity.
