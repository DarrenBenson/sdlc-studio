...
| BG0597 | not-stop-ship | authoring session | 2026-08-19 |
| BG0598 | not-stop-ship | authoring session | 2026-08-19 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BG0585 | 2 | 88,854 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0584 | 2 | 88,854 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0589 | 1 | 44,427 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0590 | 1 | 44,427 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
...
Review passes, by phase - read from the two verdict ledgers:
  ...
  code review: 10 pass(es) over 4 unit(s), 4 rejected
Unmeasured: BG0585, BG0584, BG0589, BG0590. They are excluded from the batch ratio - an unmeasured unit is not evidence that the estimate was right.
...
- [HO-0060](../handoffs/HO0060-a-design-run-that-did-its-work-can.md) - 0 remaining item(s): 0 copilot-tail, 0 judgement. Pick up with `sprint plan --worklist sdlc-studio/.local/handoff-worklist.txt`.
