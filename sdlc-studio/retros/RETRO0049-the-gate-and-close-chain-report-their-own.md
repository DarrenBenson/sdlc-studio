...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| US0216 | 2 | 50,000 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0213 | 3 | 75,000 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0219 | 3 | 75,000 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0220 | 3 | 75,000 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0217 | 3 | 75,000 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0215 | 3 | 75,000 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0214 | 2 | 50,000 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0190 | 2 | 50,000 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0218 | 5 | 125,000 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| **Batch (rated units only)** | **0** | **0** | **0** | - | **-** | | **-** | - |

**0 of 9 unit(s) measured; 9 of 9 forecast at plan time.**

**Velocity: 9.84 points/elapsed-hour** (26 points over 2.642h, run-state, ceremony included). This is the planning number - points per SESSION within the observed single-session envelope; it is NOT a linear per-point rate to extrapolate to a 1-point or 100-point sprint, and it is descriptive, never a target.

  secondary (points/worker-hour): UNMEASURED - no runner worker-time records (an interactive sprint has none).
Unmeasured: US0216, US0213, US0219, US0220, US0217, US0215, US0214, BG0190, US0218. They are excluded from the batch ratio - an unmeasured unit is not evidence that the estimate was right.
...
- [HO-0007](../handoffs/HO0007-the-gate-and-close-chain-report-their-own.md) - 8 remaining item(s): 0 copilot-tail, 8 judgement. Pick up with `sprint plan --worklist sdlc-studio/.local/handoff-worklist.txt`.
