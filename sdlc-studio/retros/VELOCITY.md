...
| RETRO0096 | 2026-08-06 | 0 | 0 | 0 | - | - | - | - | - | - | 0 | - | - | - | - | unforecast | - | not attributable: no unit carries per-unit telemetry and no sprint total was supplied, so the sprint's token cost is unrecorded rather than 0 | - |
