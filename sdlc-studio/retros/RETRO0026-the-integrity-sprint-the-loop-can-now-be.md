...
| --- | --- | --- | --- | --- | --- |
| BG0133 | 23 | 63,800 | 217,139 | 0.29x | 1431s |
| BG0134 | 0 | 50,000 | 71,935 | 0.7x | 428s |
| BG0135 | 52 | 81,200 | 173,804 | 0.47x | 1246s |
| CR0252 | 0 | 80,000 | 205,534 | 0.39x | 1134s |
| BG0136 | 39 | 73,400 | 234,091 | 0.31x | 1767s |
| **Batch (rated units only)** | | **348,400** | **902,503** | **0.39x** | **6006s** |

**5 of 5 unit(s) measured; 5 of 5 forecast at plan time.**

Forecast by `base=50000 tpc=600`, recorded at plan time. OUT-OF-SAMPLE: forecast by the constants in force, on a sprint they were not fitted to. This is the only kind of row that tells you anything.
