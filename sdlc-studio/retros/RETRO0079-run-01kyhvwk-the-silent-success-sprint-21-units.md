...
> **Date:** 2026-07-27
> **Batch:** RUN-01KYHVWK - 21 units (16 bugs, 5 stories), 70 points: BG0302, BG0303, BG0304, BG0305, BG0306, BG0314, BG0315, BG0316, BG0317, BG0321, BG0322, BG0323, BG0324, BG0325, BG0326, BG0329, US0447, US0448, US0449, US0450, US0451
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BG0302 | 5 | 298,155 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0303 | 5 | 298,155 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0304 | 5 | 298,155 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0305 | 5 | 298,155 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0306 | 5 | 298,155 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0314 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0315 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0316 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0317 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0321 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0322 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0323 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0324 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0325 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0326 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0329 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0447 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0448 | 3 | 178,893 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0449 | 2 | 119,262 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0450 | 2 | 119,262 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| US0451 | 2 | 119,262 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| **Batch (rated units only)** | **0** | **0** | **0** | - | **-** | | **-** | - |

**0 of 21 unit(s) measured; 21 of 21 forecast at plan time.**
...
Unmeasured: BG0302, BG0303, BG0304, BG0305, BG0306, BG0314, BG0315, BG0316, BG0317, BG0321, BG0322, BG0323, BG0324, BG0325, BG0326, BG0329, US0447, US0448, US0449, US0450, US0451. They are excluded from the batch ratio - an unmeasured unit is not evidence that the estimate was right.
...
| 2026-07-28 | Claude Opus 5 | Batch line back-annotated with the unit ids from the archived run state (`sdlc-studio/.local/run-archive/RUN-01KYHVWK.json`). The close DID happen and this retro is it; the line named the run and the counts in prose, so `retro.batch_ids` read zero units and `close_owed` could not attribute a single one of them - the same defect BG0362 describes. The ids are the run's own recorded batch, not a reconstruction. |
