...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BG0606 | 5 | 189,435 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0592 | 3 | 133,281 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0611 | 3 | 113,661 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0609 | 2 | 75,774 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0605 | 2 | 75,774 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0604 | 3 | 113,661 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0610 | 3 | 113,661 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0600 | 2 | 75,774 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0581 | 3 | 133,281 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0586 | 3 | 133,281 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0587 | 2 | 88,854 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
| BG0588 | 3 | 133,281 | - | **UNMEASURED** (no telemetry token record) | - | - | - | - |
...
Review passes, by phase - read from the two verdict ledgers:
  ...
  code review: 7 pass(es) over 4 unit(s), 7 rejected
Unmeasured: BG0606, BG0592, BG0611, BG0609, BG0605, BG0604, BG0610, BG0600, BG0581, BG0586, BG0587, BG0588. They are excluded from the batch ratio - an unmeasured unit is not evidence that the estimate was right.
...
- [HO-0063](../handoffs/HO0063-twelve-of-thirteen-closed-and-bg0607-opens-the.md) - 0 remaining item(s): 0 copilot-tail, 0 judgement. Pick up with `sprint plan --worklist sdlc-studio/.local/handoff-worklist.txt`.
