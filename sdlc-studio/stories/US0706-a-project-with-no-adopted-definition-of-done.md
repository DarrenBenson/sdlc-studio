# US0706: A project with no adopted definition-of-done inherits the clause from the shipped template
...
**As a** Maya Okafor
**I want** A project with no adopted definition-of-done inherits the clause from the shipped template
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - inheritance of a retired clause |
