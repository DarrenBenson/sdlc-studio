...
> **Affects:** tools/known_issues.py, tools/tests/test_known_issues.py, tools/tests/test_lean_release_notes.py, docs/release-notes-v5.1.0.md, docs/known-issues.md, .githooks/pre-push
> **Epic:** EP0262
> **Points:** 2
> **Persona:** Maya Okafor
