# US0727: `sprint status` states the open span without anyone running the close
...
**As a** Maya Okafor
**I want** `sprint status` states the open span without anyone running the close
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): SUPERSEDED - sprint status open span: follows US0725 |
