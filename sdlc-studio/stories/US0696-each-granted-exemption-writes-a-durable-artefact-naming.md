# US0696: Each granted exemption writes a durable artefact naming the era, the reason and the re-arm condition
...
**As a** Maya Okafor
**I want** Each granted exemption writes a durable artefact naming the era, the reason and the re-arm condition
**So that** CR0497 is delivered by work that can be planned and checked
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - [+constraint] durable exemption artefact per grant: new ledger |
