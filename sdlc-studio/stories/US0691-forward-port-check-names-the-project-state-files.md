# US0691: `forward-port --check` names the project-state files its verdict deliberately excludes
...
**As a** Maya Okafor
**I want** `forward-port --check` names the project-state files its verdict deliberately excludes
