# US0778: The appetite reports WORKING time, derived from the evidence the run itself leaves
...
**As a** Maya Okafor
**I want** The appetite reports WORKING time, derived from the evidence the run itself leaves
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): SUPERSEDED - US0871 measures per-unit elapsed time as delivered |
