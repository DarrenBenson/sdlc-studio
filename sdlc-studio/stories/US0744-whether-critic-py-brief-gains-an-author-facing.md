# US0744: Whether `critic.py brief` gains an author-facing form is decided and recorded either way
...
**As a** Maya Okafor
**I want** Whether `critic.py brief` gains an author-facing form is decided and recorded either way
**So that** CR0529 is delivered by work that can be planned and checked
