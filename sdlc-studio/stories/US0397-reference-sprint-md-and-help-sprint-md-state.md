...
### AC3: It prescribes NO number: with two measured sprints there is no defensible optimum, and inventing

- **Given** {{context}}
- **When** {{action}}
- **Then** It prescribes NO number: with two measured sprints there is no defensible optimum, and inventing one repeats the mistake BG0254 was filed about.
- **Verify:** {{executable check}}
