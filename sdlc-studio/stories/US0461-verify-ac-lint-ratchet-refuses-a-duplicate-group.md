...
- **Verify:** manual - retired by US0897: the verify-lint ratchet, its baseline and the pre-commit lane were deleted; a shared selector is an advisory note within one artefact
