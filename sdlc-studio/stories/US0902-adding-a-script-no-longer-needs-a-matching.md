...
> **Affects:** tools/check_script_tests.py, tools/tests/test_check_script_tests.py, .githooks/pre-commit, package.json, AGENTS.md, sdlc-studio/tsd.md, tools/tests/test_precommit_lane_order.py, tools/tests/test_lean_tsd_script_pin.py
> **Epic:** EP0262
> **Points:** 1
> **Persona:** Maya Okafor
