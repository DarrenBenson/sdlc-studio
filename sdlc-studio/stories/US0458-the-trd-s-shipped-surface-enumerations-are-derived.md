...
- **Verify:** manual - retired by US0933: CR0132 is Complete and US0933 rewrote the Error / report format block without the caveat, so the denylist guarding it went with the deleted pin module (D0266)
- **Verified:** manual (2026-09-25) - retired, superseded by US0933
