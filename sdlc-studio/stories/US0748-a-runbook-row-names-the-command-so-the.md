# US0748: A runbook row names the command, so the parallelisable question has a command behind it
...
**As a** Maya Okafor
**I want** A runbook row names the command, so the parallelisable question has a command behind it
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - runbook row |
