...
- **Verify:** manual - retired by US0919: the sign-off panel is retired; the operator signs the run once at `sprint sign`
...
| 2026-09-25 | US0919 | AC1, AC2, AC3 and AC4 retired in the D0259 pattern: the sign-off panel is retired; the operator signs the run once at `sprint sign` |
