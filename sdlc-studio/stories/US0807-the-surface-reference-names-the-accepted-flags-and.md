# US0807: The surface reference names the accepted flags and document keys per verb

> **Status:** Superseded
> **Closed with findings in:** D0265 backlog sweep 2026-09-24 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md), MERGE: merged into US0804
> **Delivers:** CR0559
> **Created:** 2026-08-27
...
**As a** Maya Okafor
**I want** The surface reference names the accepted flags and document keys per verb
**So that** CR0559 is delivered by work that can be planned and checked
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): MERGE, merged into US0804 - US0804 |
