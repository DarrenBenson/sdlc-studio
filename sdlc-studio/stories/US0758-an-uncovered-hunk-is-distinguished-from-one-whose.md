# US0758: An uncovered hunk is distinguished from one whose verifiers could not RUN
...
**As a** Maya Okafor
**I want** An uncovered hunk is distinguished from one whose verifiers could not RUN
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - verdict nuance for the retired check |
