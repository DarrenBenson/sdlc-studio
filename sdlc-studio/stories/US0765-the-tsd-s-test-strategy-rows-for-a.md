# US0765: The TSD's test-strategy rows for a shipped gate are DERIVED from the same source
...
**As a** Maya Okafor
**I want** The TSD's test-strategy rows for a shipped gate are DERIVED from the same source
**So that** CR0536 is delivered by work that can be planned and checked
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - derived TSD gate rows |
