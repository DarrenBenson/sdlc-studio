# US0754: The check reverts each hunk of a unit's declared Affects in turn and reports GREEN as uncovered
...
**As a** Maya Okafor
**I want** The check reverts each hunk of a unit's declared Affects in turn and reports GREEN as uncovered
