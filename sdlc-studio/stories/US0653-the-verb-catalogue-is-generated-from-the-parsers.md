...
- **Then** no generated ROW contains any `option_string` the enumeration knows about - asserted
  ...
  on prose the generator emits. 677 rows would need a budget allowlist entry on the day the page
...
| AC3 | build the expected list by calling the live enumerator rather than the patched fake | the catalogue lists every verb |
