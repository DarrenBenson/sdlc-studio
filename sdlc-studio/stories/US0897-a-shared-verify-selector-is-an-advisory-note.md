...
| 2026-09-24 | Claude Opus 5.5 | Delivery note: AC4's parenthetical named US0227, BG0431 and BG0603 among the criteria naming a deleted node; none does (verified green), so they were rightly not retired - the operative rule is every stamped criterion naming one |
