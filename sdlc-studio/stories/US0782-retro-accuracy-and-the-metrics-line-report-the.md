# US0782: `retro accuracy` and the Metrics line report the working figure with the calendar beside it
...
**As a** Maya Okafor
**I want** `retro accuracy` and the Metrics line report the working figure with the calendar beside it
**So that** CR0551 is delivered by work that can be planned and checked
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): SUPERSEDED - US0875 estimates row replaces retro accuracy line |
