# US0752: SC0001's query and its prose rule agree, pinned by a test
...
**As a** Maya Okafor
**I want** SC0001's query and its prose rule agree, pinned by a test
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - repo-specific SC0001 prose/query pin |
