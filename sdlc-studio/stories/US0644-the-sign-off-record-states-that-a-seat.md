...
- **Verify:** manual - retired by US0919: no per-unit sign-off row is written, so no capacity is recorded
...
| 2026-09-25 | US0919 | AC1, AC2, AC3, AC4 and AC5 retired in the D0259 pattern: no per-unit sign-off row is written, so no capacity is recorded |
