...
- **Verify:** manual - retired by US0919: the frozen sign-off ledger is no longer read, so there is no delegated sign-off to disclose
...
| 2026-09-25 | US0919 | AC1 and AC2 retired in the D0259 pattern: the frozen sign-off ledger is no longer read, so there is no delegated sign-off to disclose |
