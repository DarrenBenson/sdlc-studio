...
- **Verify:** manual - retired by US0909: the rebaseline's re-review bucket went with the plan-review gate, its only filler; the census buckets backfill and residual
...
| 2026-09-25 | Claude Opus 5.5 | AC1, AC2, AC3, AC4 retired by US0909 (D0259 pattern): the rebaseline's re-review bucket went with the plan-review gate, its only filler; the census buckets backfill and residual |
