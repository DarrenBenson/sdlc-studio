...
**As a** Maya Okafor
**I want** The close reports units delivered outside the batch as a non-blocking row naming each id
**So that** CR0546 is delivered by work that can be planned and checked
