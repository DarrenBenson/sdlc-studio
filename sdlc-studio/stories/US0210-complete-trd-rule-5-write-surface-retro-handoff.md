...
- **Verify:** grep "retro.py. writes the batch retro artefact" sdlc-studio/trd.md
...
- **Verify:** grep "authoritative catalogue of the script write surface" sdlc-studio/trd.md
- **Verified:** yes (2026-07-17)
