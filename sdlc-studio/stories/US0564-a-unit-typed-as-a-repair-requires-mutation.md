...
> **Affects:** .claude/skills/sdlc-studio/scripts/mutation.py, .claude/skills/sdlc-studio/scripts/transition.py, .claude/skills/sdlc-studio/scripts/tests/test_mutation.py, .claude/skills/sdlc-studio/scripts/tests/test_transition.py, sdlc-studio/stories/US0564-a-unit-typed-as-a-repair-requires-mutation.md
> **Epic:** EP0191
> **Points:** 5
> **Persona:** Maya Okafor
