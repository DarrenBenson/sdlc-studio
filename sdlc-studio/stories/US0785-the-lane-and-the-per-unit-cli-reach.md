# US0785: The lane and the per-unit CLI reach the same verdict for the same reason - one measurement
...
**As a** Maya Okafor
**I want** The lane and the per-unit CLI reach the same verdict for the same reason - one measurement
