# US0708: `brief` gains a review KIND beside `--seat`, each emitting the standing practices for that kind
...
**As a** Maya Okafor
**I want** `brief` gains a review KIND beside `--seat`, each emitting the standing practices for that kind
