...
| 2026-09-21 | audit ruling | RUN-01M306PY sweep: retired as Won't Implement. Its declared parent is CR0549, which is Superseded with its remedy WITHDRAWN on 2026-08-24 after a third rejection; the sibling CR0550 retracted itself the same day and is now Rejected. (Corrected 2026-09-21: the first wording named CR0550 as this story's parent, which its own `Delivers:` line contradicts. The substance is unchanged - both requests are dead - but the provenance was wrong.) D0150 forbids gating review depth on any author-declared field, which is the approach this story takes; and a pre-code goal review rejected this batch three times. It was blocking EP0217 from deriving Done, which in turn blocked CR0547 and CR0548 - two requests that were FINISHED - from closing. The request was done, the link was not. |
