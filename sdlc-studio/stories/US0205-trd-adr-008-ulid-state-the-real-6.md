...
- **Verify:** grep -E "1 in 1024" sdlc-studio/trd.md
...
- **Verify:** grep -E "collisions. is the guard" sdlc-studio/trd.md
...
- **Verify:** grep -E "Collision-resistant short-ULID artefact ids" sdlc-studio/trd.md
