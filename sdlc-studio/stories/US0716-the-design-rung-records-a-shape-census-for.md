# US0716: The design rung records a SHAPE CENSUS for any parser or matcher a unit adds, counted before implementation
...
**As a** Maya Okafor
**I want** The design rung records a SHAPE CENSUS for any parser or matcher a unit adds, counted before implementation
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - [+constraint] design-rung shape census before implementation: new pre-implementation ritual |
