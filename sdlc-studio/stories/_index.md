...
| [US0277](US0277-mutation-run-reports-its-selected-test-files-and.md) | Mutation run reports its selected test files and records the test command in the JSON result | Draft | EP0091 | 2026-07-20 | 2026-07-20 |
| [US0278](US0278-warn-when-a-test-file-that-references-the.md) | Warn when a test file that references the target module falls outside the test command's selection | Draft | EP0091 | 2026-07-20 | 2026-07-20 |
| [US0279](US0279-an-interactive-close-captures-the-harness-tracked-token.md) | An interactive close captures the harness-tracked token total into the velocity row without hand entry | Draft | EP0091 | 2026-07-20 | 2026-07-20 |
