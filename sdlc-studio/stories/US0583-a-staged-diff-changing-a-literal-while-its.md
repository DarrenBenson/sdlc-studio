...
- **Verify:** manual - retired by US0879: the claim-drift check in tools/check_spec_claims.py, with its lane, was deleted as a docs-against-docs lane that caught nothing
