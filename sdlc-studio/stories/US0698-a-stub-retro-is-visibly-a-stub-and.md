# US0698: A stub retro is visibly a stub, and the accuracy and velocity paths exclude it from both sides
...
**As a** Maya Okafor
**I want** A stub retro is visibly a stub, and the accuracy and velocity paths exclude it from both sides
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - stub-retro exclusion from accuracy: follows US0697 |
