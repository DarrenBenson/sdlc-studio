# US0740: The toolchain runbook's DELIVER section names the prior-art check with its command
...
**As a** Maya Okafor
**I want** The toolchain runbook's DELIVER section names the prior-art check with its command
