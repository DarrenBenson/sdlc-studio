# US0738: The `sprint close` installed-copy gate is UNCHANGED and still blocks
...
**As a** Maya Okafor
**I want** The `sprint close` installed-copy gate is UNCHANGED and still blocks
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): SUPERSEDED - US0889 replaced the blocking installed-copy gate with a mirror |
