...
**As a** Maya Okafor
**I want** refine runs a stakeholder consult over the epic and its stories and records it as an artefact naming the units it covered
**So that** RFC0058 is delivered by work that can be planned and checked
