# US0805: A `--fields-file` document whose keys are spelled as the verb's own flags is accepted
...
**As a** Maya Okafor
**I want** A `--fields-file` document whose keys are spelled as the verb's own flags is accepted
