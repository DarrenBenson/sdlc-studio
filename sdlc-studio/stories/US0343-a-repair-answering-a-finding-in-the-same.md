...
- **Verify:** pytest .claude/skills/sdlc-studio/scripts/tests/test_plan_review.py::DesignDecisionTests::test_a_repeat_class_plan_without_a_retain_or_change_statement_is_refused
...
- **Verify:** pytest .claude/skills/sdlc-studio/scripts/tests/test_plan_review.py::DesignDecisionTests::test_past_the_threshold_a_retained_design_is_refused_and_names_the_failed_rounds
...
- **Verify:** pytest .claude/skills/sdlc-studio/scripts/tests/test_plan_review.py::DesignDecisionTests::test_a_reasoned_retain_below_the_threshold_is_accepted_and_its_reason_stored
...
- **Verify:** pytest .claude/skills/sdlc-studio/scripts/tests/test_plan_review.py::DesignDecisionTests::test_the_default_threshold_carries_its_basis_and_a_project_value_overrides_it
