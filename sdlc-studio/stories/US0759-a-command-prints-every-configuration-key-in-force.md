# US0759: A command prints every configuration key in force with its value, its source and its meaning
...
**As a** Maya Okafor
**I want** A command prints every configuration key in force with its value, its source and its meaning
