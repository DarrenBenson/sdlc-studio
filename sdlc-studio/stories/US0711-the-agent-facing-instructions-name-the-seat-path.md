# US0711: The agent-facing instructions name the seat path as the only supported route to an adversarial review
...
**As a** Maya Okafor
**I want** The agent-facing instructions name the seat path as the only supported route to an adversarial review
**So that** CR0503 is delivered by work that can be planned and checked
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - agent-instruction prose making the seat path the only route |
