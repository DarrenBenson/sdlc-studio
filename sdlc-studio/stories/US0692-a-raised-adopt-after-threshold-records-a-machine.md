# US0692: A raised adopt_after threshold records a machine-readable restore condition beside the number
...
**As a** Maya Okafor
**I want** A raised adopt_after threshold records a machine-readable restore condition beside the number
