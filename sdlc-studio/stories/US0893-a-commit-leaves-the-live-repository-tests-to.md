...
> **Affects:** .claude/skills/sdlc-studio/scripts/gate.py, pytest.ini, .claude/skills/sdlc-studio/scripts/tests/test_gate.py, .claude/skills/sdlc-studio/scripts/tests/test_lean_test_selection.py, .claude/skills/sdlc-studio/help/gate.md
> **Epic:** EP0262
> **Points:** 2
> **Persona:** Maya Okafor
