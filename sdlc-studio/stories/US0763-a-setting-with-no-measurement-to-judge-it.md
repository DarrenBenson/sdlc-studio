# US0763: A setting with no measurement to judge it against is reported as UNJUDGED rather than left out
...
**As a** Maya Okafor
**I want** A setting with no measurement to judge it against is reported as UNJUDGED rather than left out
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - UNJUDGED report rows: new report section |
