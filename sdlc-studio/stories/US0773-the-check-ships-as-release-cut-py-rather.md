# US0773: The check ships as `release_cut.py` rather than in repo-only `tools/`
...
**As a** Maya Okafor
**I want** The check ships as `release_cut.py` rather than in repo-only `tools/`
...
| 2026-09-24 | Claude Opus 5.5 | Backlog sweep D0265 (sdlc-studio/reviews/backlog-sweep-2026-09-24.md): RETIRE - move the check into shipped release_cut: no consumer evidence |
