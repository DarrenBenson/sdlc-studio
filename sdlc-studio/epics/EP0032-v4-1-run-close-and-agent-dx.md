...
- [ ] [CR0224](../change-requests/CR0224-multi-repo-context-the-repo-map-and-census.md) - cross-repo Depends-on resolution: lift blocker_sweep's manifest resolver into a shared helper (rescoped per D0019; the PVD-wide edge list went to RFC0030) (independent)
