...
- [x] [US0476: RFC0009 records its partial supersession by RFC0038, to the RFC0034 convention, element by element](../stories/US0476-rfc0009-records-its-partial-supersession-by-rfc0038-to.md)
- [x] [US0477: reconcile derives the epic index's Stories and Deps cells from the census and syncs them](../stories/US0477-reconcile-derives-the-epic-index-s-stories-and.md)
- [x] [US0478: The mint path writes the canonical epic row, and the shipped template declares the same columns](../stories/US0478-the-mint-path-writes-the-canonical-epic-row.md)
