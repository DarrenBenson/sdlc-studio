...
- [x] [US0065: Triage status vocabulary and gated transitions recording triaged_by](../stories/US0065-triage-status-vocabulary-and-gated-transitions-recording-triaged.md)
- [x] [US0066: Human sampling policy and triage-quality metrics](../stories/US0066-human-sampling-policy-and-triage-quality-metrics.md)
- [x] [US0067: Triage noise controls: Medium-plus individual, Low consolidated, session cap](../stories/US0067-triage-noise-controls-medium-plus-individual-low-consolidated.md)
- [x] [US0068: Optional tranche reference field, record-only](../stories/US0068-optional-tranche-reference-field-record-only.md)
