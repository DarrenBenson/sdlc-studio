...
- [x] [US0461: verify_ac lint --ratchet refuses a duplicate group the baseline does not record with a reason, and the pinned pre-commit lane set gains it](../stories/US0461-verify-ac-lint-ratchet-refuses-a-duplicate-group.md)
