# EP0259: WS2: the sprint records the boundary it may decide inside, and the plan refuses a goal that reaches past it
...
Decomposed from RFC0060. Delivers the work RFC0060 requested.
