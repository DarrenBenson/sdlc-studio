...
- [ ] [US0610: tools/run-suite.sh runs a suite and writes exit_code, counts, duration and head_sha to sdlc-studio/.local/suite-verdict.json, printing only the verdict line](../stories/US0610-tools-run-suite-sh-runs-a-suite-and.md)
