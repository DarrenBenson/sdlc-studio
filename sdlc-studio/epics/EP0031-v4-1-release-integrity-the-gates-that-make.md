...
- [ ] [CR0236](../change-requests/CR0236-the-lessons-close-loop-is-doctrine-not-mechanism.md) - the lessons close-loop is doctrine, not mechanism: gate the summary at close and surface it at plan (operator directive; same defect class as BG0111 - a documented intention with no implementation)
