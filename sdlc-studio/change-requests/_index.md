...
| [CR-0132](CR0132-reconcile-status-vocabulary-must-be-project-configurable-drift.md) | reconcile status vocabulary must be project-configurable (drift-0 unreachable with bespoke statuses) | Proposed | High | Improvement | 2026-07-04 | -- |
