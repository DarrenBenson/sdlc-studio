...
| [CR-0134](CR0134-executable-mutation-check-test-quality-gate-enforce-assertion.md) | executable mutation-check / test-quality gate (enforce assertion integrity, not just document it) | In Progress | High | Feature | 2026-07-04 | -- |
