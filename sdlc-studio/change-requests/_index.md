...
| [CR-0134](CR0134-executable-mutation-check-test-quality-gate-enforce-assertion.md) | executable mutation-check / test-quality gate (enforce assertion integrity, not just document it) | Complete | High | Feature | 2026-07-04 | -- |
...
| [CR-0143](CR0143-batch-transitions-and-first-class-retro-review-types.md) | batch transitions and first-class retro/review types (deterministic-toolchain ergonomics) | Complete | Medium | Improvement | 2026-07-04 | -- |
| [CR-0144](CR0144-one-shared-structural-table-iterator-in-sdlc-md.md) | one shared structural table iterator in sdlc_md - retire the per-parser boundary bugs as a class | Complete | High | Improvement | 2026-07-04 | -- |
...
| [CR-0150](CR0150-status-hint-surface-an-advisory-when-the-workspace.md) | status/hint surface an advisory when the workspace carries artifact changes this session did not make | Approved | Medium | Improvement | 2026-07-04 | -- |
