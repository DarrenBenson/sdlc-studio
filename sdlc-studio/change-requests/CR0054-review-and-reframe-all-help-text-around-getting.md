...
- [ ] help/help.md leads with getting-started + the autosprint loop; every command (incl. pvd, gate, provenance, telemetry, new/close, skill-update, product reconcile) is listed in the catalogue
- [ ] help/arguments.md + help/references.md cover the new commands/flags and reference-pvd/reference-skill-update
- [ ] the human-driven-tool and persona deep-dive content is retained but secondary (runnable on demand, not the headline)
- [ ] reviewed for consistency; the steer is getting-started + autosprint
