...
| [RFC-0009](RFC0009-code-complexity-signals.md) | Code-complexity signals for estimation, token budgeting, refactor-first and test risk | High | Accepted | -- | 2026-06-20 | -- |
...
| [RFC-0013](RFC0013-ecosystem-neutral-deploy-last-mile.md) | the deploy last-mile, without ecosystem lock-in | High | Accepted | -- | 2026-06-21 | -- |
...
| [RFC-0040](RFC0040-upgrade-and-migration-path-for-the-sizing-and.md) | Upgrade and migration path for the sizing and two-backlog model, before release | P1 | Accepted | sdlc-studio | 2026-07-15 | -- |
...
| [RFC-0055](RFC0055-guided-init-one-orchestrated-onboarding-flow-greenfield-brownfield.md) | Guided init: one orchestrated onboarding flow (greenfield + brownfield) from zero to first sprint plan - AGENTS.md, PRD, TRD, TSD, personas, best practice baked in | Medium | In Review | sdlc-studio | 2026-07-26 | -- |
