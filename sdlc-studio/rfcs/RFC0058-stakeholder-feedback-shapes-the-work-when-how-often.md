...
| 2026-09-21 | audit ruling | still wanted, correctly in progress. Judged on the same bar as every CR here, and it passes on a distinction that matters: an RFC's deliverable is a RULING, and three and a half of its six decisions were ruled by the operator on 2026-09-16 and 2026-09-17 - the most recent activity anywhere in this cluster. D3, D5's refresh half and D6 remain and are deferred to refine. Its unbuilt state is exactly what its open decisions predict, which is the difference between an RFC in progress and a CR abandoned. |
