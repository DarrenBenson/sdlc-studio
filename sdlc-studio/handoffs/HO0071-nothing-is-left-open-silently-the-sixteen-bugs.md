...
5 of 23 unit(s) remain (0 suit copilot-assisted completion, 5 need human judgement). Plan them straight back in:
...
- **Spent:** 2003.8 min, 23 unit(s) terminal
- **Delivered:** 18 unit(s)
...
| [US0823](../../sdlc-studio/stories/US0823-every-other-route-that-ends-a-run-reads.md) | story | Done | 6/6 AC(s) verified; critic APPROVE (Dani Okafor (engineering seat, independent subagent, delivery)) |
...
### US0625 (story, Done) - judgement

- **check:** `verify:unproven` - the file says delivered; the evidence says 3 red AC(s) - reconcile the two (re-run verify_ac, fix, or reopen)
...
- **Suitability:** judgement (confidence high) - seeded by verify:unproven, difficulty:extreme

### US0626 (story, Done) - judgement
