...
| .claude/skills/sdlc-studio/scripts/sprint.py | 11291 | c12816bc94b60500 | queue show mirrors next's not-materialised line from the same helper; no criterion names queue show, and the line was exercised by hand through sprint.py queue show and by the BG0674 delivery review. The missing test is filed as BG0699. Re-ruled at its new line: another batch unit's edit to the file voided the earlier ruling by whole-file hash (BG0706). | Claude Opus 5 (authoring session) | 2026-09-15 |
| .claude/skills/sdlc-studio/scripts/sprint.py | 11292 | c12816bc94b60500 | the print half of the same queue show mirror as the line above, exercised through the CLI by hand; the missing test is filed as BG0699. Re-ruled at its new line: another batch unit's edit to the file voided the earlier ruling by whole-file hash (BG0706). | Claude Opus 5 (authoring session) | 2026-09-15 |
| .claude/skills/sdlc-studio/scripts/tests/test_sprint.py | 15519 | f96881e016edb79d | fixture helper: removes a config left by an earlier case; each test builds a fresh tree, so the branch is defensive. Re-ruled at its new line: another batch unit's edit to the file voided the earlier ruling by whole-file hash (BG0706). | Claude Opus 5 (authoring session) | 2026-09-15 |
