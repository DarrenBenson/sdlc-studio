...
| 2026-09-25 | Claude Opus 5.5 | Round-1 review: AC1's Verify widened to the CrFilingTests class so its bug clause is run; Affects gains the three texts that described the retired CR size demand, and test_two_backlogs.py |
