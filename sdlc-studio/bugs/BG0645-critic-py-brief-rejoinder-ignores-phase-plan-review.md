...
> **Status:** Open
> **Verification depth:** functional [[derived: criteria 2; plan rows 3; EVIDENCE ABSENT - the mutation ledger holds no entry for this unit, which is not the same fact as nought killed; NOT RUN 3 (AC1 row 0, AC1 row 1, AC2 row 0); entry point 0 of 2 criteria through the shipped CLI, 0 in-process; 2 undetermined (the named node could not be isolated) | fp 6a09dc7c4704 ]]
> **Severity:** Medium
> **Points:** 2
