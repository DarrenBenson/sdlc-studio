...
> **Evidence:** Found by running `/sdlc-studio hint` on 2026-08-26. Marker dated 2026-08-14 02:47 with 7/7 stages pending; each stage's output verified present on disk by a scan before filing. Gate behaviour quoted from source at status.py:490-492 and init.py:311-314 per D0151.
> **Created:** 2026-08-26
...
- [ ] **AC1** The behaviour described is corrected: `status._compute_hint_rung` calls `_onboarding_hint` FIRST and returns its answer whenever any stage is pending (status.py:490-492), and...
- [ ] **AC2** The proposed fix lands, pinned by a test: Make the onboarding hint FALSIFIABLE by the tree.
