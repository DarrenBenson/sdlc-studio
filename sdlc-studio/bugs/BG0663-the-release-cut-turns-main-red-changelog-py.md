...
| 2026-09-20 | operator ruling | D0221: the retro this unit owes folds into the NEXT run's close rather than paying a separate close ceremony for one unit. The `close owed` advisory stands until that run closes, and is expected rather than unnoticed. |
