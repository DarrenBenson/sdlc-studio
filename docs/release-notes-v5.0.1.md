...
**v5.0.1 ships with 17 open defects: 17 Medium, 0 Low. Zero Critical, zero High.** Listed by id in
...
Down from the 40 v5.0.0 disclosed. 23 closed while clearing the bug backlog - and five of
