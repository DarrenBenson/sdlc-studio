...
**v5.0.1 ships with 14 open defects: 14 Medium, 0 Low. Zero Critical, zero High.** Listed by id in
...
Down from the 40 v5.0.0 disclosed. 26 closed while clearing the bug backlog - and five of
