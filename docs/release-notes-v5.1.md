...
filed all five disclosed here, every one from a review or a gate that was doing its job, and
...
**v5.1 discloses 5 open defects: 5 Medium, 0 Low.** Zero Critical, zero High.
