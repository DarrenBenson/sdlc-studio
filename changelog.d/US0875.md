...
- **The sprint report is one page that answers three questions, with everything else in an
  ...
  than inside it, with dropped and carried units listed with their recorded reasons and the
  review rounds each unit took; two of four planned units plus one added no longer reads as
