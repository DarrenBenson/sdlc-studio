...
lands refused. The three tests drive `lint --ratchet --bugs` as a subprocess over a seeded fixture
tree, because plain `lint` walks stories only, and the tree seeds an empty dup-ratchet baseline: the
